    ...
    >
      ...
      <b-collapse id="collapse1" visible>
        <b-card-body>
          <div class="row">
            <div class="col-md-12">
              <router-link :to="{ name: 'workflow-definition'}" class="btn btn-secondary">
...
export default {
  ...
  methods: {
    ...
    deleteAction(index) {
      ...
      getTypes() {
        var urlStr =
          this.$store.getters.serverURI + "api/Workflow/GetAllWorkflowTypes";
        this.$http
          .get(urlStr, {
      ...
      addEditWorkflow() {
        this.$validator.validateAll("WorkflowValidation").then(result => {
          if (result) {
            var urlStr = this.$store.getters.serverURI + "api/WorkflowSetting";
            if (this.WorkflowId) {
              var workflowStep = [];
              for (
                var i = 0;
              ...
              this.$http
                ...
                .then(
                  response => {
                    ...
                    this.clearAll();
                    this.$router.push({
                      path: "/workflow-definition/WorkflowDefinitionList"
                    });
                  },
                  function(error) {
                    this.fullscreenLoading = false;
      ...
      saveActions() {
        var urlStr =
          ...
          "api/WorkflowSetting/UpdateActions?stepId=" +
          this.StepId;
        this.$http
      ...
      saveUserAndRole() {
        var urlStr =
          this.$store.getters.serverURI +
          "api/WorkflowSetting/UpdateUserAndRole?stepId=" +
          this.StepId;
      ...
      getActionsFromService: function() {
        var urlStr =
          this.$store.getters.serverURI +
          "api/WorkflowSetting/GetActions/" +
          this.StepId;
        this.$http
          .get(urlStr, {
            headers: this.$store.getters.tokenAuthonticationHeaderObj
      ...
      getUsersAndRolesFromService: function() {
        var urlStr =
          this.$store.getters.serverURI +
          "api/WorkflowSetting/GetUsersAndRoles/" +
          this.StepId;
        this.$http
          .get(urlStr, {
            headers: this.$store.getters.tokenAuthonticationHeaderObj
