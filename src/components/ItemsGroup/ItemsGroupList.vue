          ...
          <div class="row">
            <div class="col-md-12 mt-3 mb-3">
              ...
              <router-link
                ...
                :to="{ name: 'ItemsGroupConfiguration'}"
              ...
              <tr v-for="(Group, index) in ItemsGroup" v-bind:key="index">
                ...
                <td class="action-column">
                  <router-link
                    ...
                    :title="$t('Edit')"
                    class="text-primary"
                    :to="{ name: 'ItemsGroupConfiguration', params: {GroupId: Group.id}}">
      ...
      this.$msgbox({
        ...
        beforeClose: (action, instance, done) => {
          if (action === "confirm") {
            ...
            var urlStr =
              this.$store.getters.serverURI + "api/ItemsGroup/" + GroupId;
            this.$http
              .delete(urlStr, {
                headers: this.$store.getters.tokenAuthonticationHeaderObj
              })
