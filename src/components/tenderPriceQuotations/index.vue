          ...
          <div class="row">
            <div class="col-md-12 mt-3 mb-3">
              ...
              <router-link
                ...
                :to="{ name: 'tenderNewPriceQuotation'}"
              ...
              <tr v-for="quote in priceQuotes">
                ...
                <td class="action-column text-center">
                  <router-link
                    ...
                    title="Action"
                    class="text-primary"
                    :to="{ name: 'tenderViewPriceQuotation', params: {quoteID: quote.id}}"
                  >
                    <i class="fa fa-eye"></i>
                  </router-link>
                  ...
                  <router-link
                    ...
                    :title="$t('Edit')"
                    class="text-primary"
                    :to="{ name: 'tenderNewPriceQuotation', params: {quoteID: quote.id}}"
                  >
  ...
  methods: {
    Excel() {
      var urlStr =
        ...
        "api/TenderPriceQuotations/ExportToExcel/?PageIndex=" +
    ...
    getPriceQuotes() {
      ...
      var urlStr =
        this.$store.getters.serverURI +
        "api/TenderPriceQuotation?PageIndex=" +
        this.page.currentPage +
        "&PageSize=" +
        this.page.itemsPerPage +
        "&subject=" +
