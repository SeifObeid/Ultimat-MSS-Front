<template>
    <div>
                    ...
                    <form class="form-horizontal">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="form-group" :class="{'has-error':errors.has('tenderName')}">

                                    <label class="col-form-label">{{$t("TenderNameMedical")}}</label>

                                    <input type="text" name="tenderName" class="form-control"
                                        v-model="BasicInfoObj.tenderName" autocomplete="off" disabled
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="form-group" :class="{'has-error':errors.has('QuotationNumber')}">
                                    ...
                                    <input type="text" name="QuotationNumber" class="form-control"
                                        v-model="BasicInfoObj.tenderNumber" autocomplete="off" disabled />
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tenderCurrencyCode" class="form-control"
                                        v-model="BasicInfoObj.tenderCurrencyCode" autocomplete="off" disabled />
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="form-group"
                                    :class="{'has-error':errors.has('vatValue') || VAT > 100 || VAT < 0 }">

                                    <label class="col-form-label">VAT value (%)</label>

                                    <input v-if="BasicInfoObj.isVat" type="number"
                                        @change="reBuildItems();getTotalAmountTotalGrossMarginTotalGrossMarginValue()"
                                        min="0" max="100" name="vatValue" class="form-control" v-model="VAT"
                                    ...
                                    <input v-if="!BasicInfoObj.isVat" disabled type="text" value="0" name="vatValue1"
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="BasicInfoObj.submissionDate" class="form-control"
                                        v-model="BasicInfoObj.submissionDate" autocomplete="off" disabled />
                            ...
                            <div class="col-md-2">
                                    <div v-if="checkWarrantyAccepted(BasicInfoObj.warrantyLookup)">
                                        <div class="form-group" :class="{ 'has-error': errors.has('Warranty') }">
                                            ...
                                            <el-select v-model="BasicInfoObj.warrantyId" disabled  :data-vv-as="$t('Warranty')"
                ...
                <b-card-body
                    ...
                    <div class="table-wrapper-scroll-y my-custom-scrollbar col-md-12">
                        <table class="table table-bordered table-striped table-sm">
                            <thead>
                                <tr>
                                    <th scope="col" class="pt-1 pb-1 text-center" width="30%">{{ $t("CurrencyName") }}
                                    </th>
                                    <th scope="col" class="pt-1 pb-1 text-center" width="20%">{{ $t("CurrencyCode") }}
                                    </th>
                                    <th scope="col" class="pt-1 pb-1 text-center" width="25%">{{ $t("ERPCurrencyRate")
                                        }}</th>
                            ...
                            <tbody>
                                <tr v-for="(currency, index) in BasicInfoObj.calculationSheetCurrencyRate"
                                    v-bind:key="index">
                                    ...
                                    <td class="align-middle text-center">
                                        <div class="row">
                                            <div class="col-sm-10">
                                                <input type="text" :id="'t' + index" :name="'t' + index"
                                                    class="form-control"
                                                    :class="{ 'has-error': errors.has('t' + index) }"
                                                    v-model="currency.manualCurrencyRate"
                                                    v-validate="'required|decimal:4'" autocomplete="off" disabled/>
                                            </div>
                ...
                <b-card-body>
                    ...
                    <b-row>
                        ...
                        <b-col lg="12">
                            ...
                            <el-button @click="ShowDialogToFetchItemFromMainConfigs()"
                                class="btn btn-secondary mt-1 mb-2">{{ $t('BuildCalculationSheetItem')}}</el-button>

                            <el-button @click="addNewGroup()" class="btn btn-secondary mt-1 mb-2"
                                v-if="calculationSheetGroups.length==0">

                                <i class="fa fa-plus"></i> {{ $t('newGroup')}}

                            </el-button>
                            <button @click="ExcelsheetDialog = true" class="pull-right btn btn-secondary mt-1 mb-2"
                                variant="secondary">
                    ...
                    <b-row v-for="(CalcGroup,index) in calculationSheetGroups" :key="index"> 
                        <b-col lg="12" class="parent-card">
                            <!-- v-if="CalcGroup.calculationSheetItem.length > 0 " -->
                            <el-button
                                @click="addNewMainSheetItem(index)" class="btn btn-secondary mt-2 mb-2">
                            ...
                            <b-card class="card card-accent-primary" no-body>
                                <div slot="header">
                                    <div class="row">
                                        <input type="checkbox" v-model="CalcGroup.selected"
                                            style="margin-left: 15px;margin-top: 10px;width: 23px;height: 17px;"
                                            @click="selectMainGroup(CalcGroup,index)" :id="'name'+index"
                                            :name="'name'+index" />
                                        ...
                                        <label for="inputEmail3"
                                            class="col-sm-1 col-md-1 col-xl-1 col-form-label">{{$t("Item")}}-{{index+1}}</label>

                                        <div class="row col-md-10 col-lg-10 col-xl-10">
                                            <div class="col-md-2 col-lg-2 col-xl-2">
                                                <div class="form-group">
                                                    <label class="col-form-label">{{$t("name")}}</label>
                                                    <el-input type="text" id="inputEmail3" v-model="CalcGroup.name"
                                                        size="mini"
                                                        :maxlength="$store.getters.getMaxLength.length200"></el-input>
                                                </div>
                                            </div>
                                            <div class="col-md-2 col-lg-2 col-xl-2">
                                                <div class="form-group">
                                                    <label class="col-form-label">{{$t("TenderItemNumber")}}</label>
                                                    <el-input type="text" id="inputEmail4" v-model="CalcGroup.number"
                                                        size="mini"
                                                        :maxlength="$store.getters.getMaxLength.length30"></el-input>
                                                </div>
                                            </div>
                                            <div class="col-md-2 col-lg-2 col-xl-2">
                                                <div class="form-group">
                                                    <label class="col-form-label">{{$t("DeliveryTerms")}}</label>
                                                    <el-input id="inputEmail3" v-model="CalcGroup.deliveryTerms"
                                                        size="mini" :maxlength="$store.getters.getMaxLength.length30">
                                                    </el-input>
                                                </div>
                                            </div>
                                            <div class="col-md-2 col-lg-2 col-xl-2">
                                                <div class="form-group">
                                                    ...
                                                    <div v-if="checkWarrantyAccepted(BasicInfoObj.warrantyLookup, CalcGroup)">
                
                                                            <div class="form-group" :class="{ 'has-error': errors.has('Warranty') }">
                                                                <label class="col-form-label">{{$t("Warranty")}}</label>

                                                                <input type="text" :key="'items-'+CalcGroup.id" disabled name="Warranty" class="form-control" v-model="CalcGroup.warranty"
                                                                :data-vv-as="$t('Warranty')" autocomplete="off" />
                                                                <div class="help-block" v-if="errors.has('Warranty')">{{ errors.first('Warranty') }}</div>
                                                            </div>
                                                        </div>
                                                        <div v-else>
                                                            <div class="form-group" :class="{ 'has-error': errors.has('Warranty') }">
                                                                ...
                                                                <input type="text" name="Warranty" class="form-control" v-model="CalcGroup.warranty"
                                                                :data-vv-as="$t('Warranty')" autocomplete="off" />
                                                                <div class="help-block" v-if="errors.has('Warranty')">{{ errors.first('Warranty') }}</div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-md-2 col-lg-2 col-xl-2">
                                                <div class="form-group">
                                                    ...
                                                    <el-select :loading="loadingAccount"
                                                        v-model="CalcGroup.bulkObj.currencyCode" clearable filterable
                                                        class="full-width padding-0" size="mini">
                                            ...
                                            <div class="col-md-2 col-lg-2 col-xl-2">
                                                <div class="form-group">
                                                    <label class="col-form-label">{{$t("Discount1")}}</label>
                                                    <el-input v-model="CalcGroup.bulkObj.discount1" size="mini"
                                                        autocomplete="off"></el-input>
                                                </div>
                                            </div>
                                            <div class="col-md-2 col-lg-2 col-xl-2">
                                                <div class="form-group">
                                                    <label class="col-form-label">{{$t("Discount2")}}</label>
                                                    <el-input v-model="CalcGroup.bulkObj.discount2" size="mini"
                                                        autocomplete="off"></el-input>
                                                </div>
                                            </div>
                                            <div class="col-md-2 col-lg-2 col-xl-2">
                                                <div class="form-group">
                                                    <label class="col-form-label">{{$t("ShipmentSG")}}</label>
                                                    <el-input v-model="CalcGroup.bulkObj.shipment" size="mini"
                                                        autocomplete="off"></el-input>
                                                </div>
                                            </div>
                                            <div class="col-md-2 col-lg-2 col-xl-2">
                                                <div class="form-group">
                                                    <label class="col-form-label">{{$t("GrossMargin")}}</label>
                                                    <el-input v-model="CalcGroup.bulkObj.grossMargin" size="mini"
                                                        autocomplete="off"></el-input>
                                                </div>
                                            </div>
                                            <div class="col-md-2 col-lg-2 col-xl-2">
                                                <div class="form-group">
                                                    ...
                                                    <el-input v-model="CalcGroup.bulkObj.quantity" size="mini"
                                                        autocomplete="off"></el-input>
                                                </div>
                                            </div>
                                            <div class="col-md-2 col-lg-2 col-xl-2">
                                                <div class="form-group">
                                                    <label class="col-form-label">{{$t("CostType")}}</label>
                                                    <el-select v-model="CalcGroup.bulkObj.costType" clearable filterable
                                                        name="CostType" class="full-width padding-3" size="mini">
                                                        <el-option v-for="option in costTypeList" :value="option.id"
                                            ...
                                            <div class="col-md-2 col-lg-2 col-xl-2">
                                                <div class="form-group">
                                                    <button type="submit" class="btn btn-success bulk"
                                ...
                                <b-collapse :id="'mainItem-'+index" visible>
                                    <b-card-body>
                                        <div class="table-responsive-lg table-responsive">
                                            <el-table class="table-sm table-responsive custom-table"
                                                :data="CalcGroup.calculationSheetItem" size="mini" style="width: 100%">
                                                ...
                                                <el-table-column label width="50" fixed>
                                                    <template slot-scope="scope">
                                                        <a class="text-danger"
                                                            @mousedown="removeCalcuationSheetMainItems(index,scope.row)">
                                                            <i class="fa fa-trash"></i>
                                                        </a>&nbsp;
                                                        <a href="javascript:void(0)" class="text-success"
                                                ...
                                                <el-table-column prop="Name" label="Item code" width="180" fixed>
                                                    <template slot-scope="scope">
                                                        <el-select remote reserve-keyword
                                                            :remote-method="remoteMethodItemsCode"
                                                            :loading="loadingAccount" v-model=" scope.row.code"
                                                            filterable size="mini" class="full-width padding-3"
                                                            @change="getItemCodeName(scope.row)">

                                                            <el-option v-for="item in systemItemsList" :key="item.id"
                                                                :label="item.code" :value="item.code"></el-option>

                                                        </el-select>
                                                    </template>
                                                </el-table-column>
                                                <el-table-column prop="Name" label="item description" width="280" fixed>
                                                    <template slot-scope="scope">
                                                        <el-select remote reserve-keyword
                                                            :remote-method="remoteMethodItemsName"
                                                            :loading="loadingAccount" v-model=" scope.row.name"
                                                            filterable size="mini" class="full-width padding-3"
                                                ...
                                                <el-table-column prop="vendor" label="Vendor" width="180">
                                                    <template slot-scope="scope">
                                                        <el-input readonly v-model="scope.row.vendor" disabled
                                                ...
                                                <el-table-column prop="onHandPrice" label="OH price" width="120">
                                                    <template slot-scope="scope">
                                                        <el-input v-model="scope.row.onHandPrice" size="mini" disabled
                                                            autocomplete="off">
                                                ...
                                                <el-table-column prop="onHandQuantity" label="OH Qty" width="120">
                                                    <template slot-scope="scope">
                                                        <el-input v-model="scope.row.onHandQuantity" size="mini"
                                                ...
                                                <el-table-column prop="Cost" label="Cost" width="120">
                                                    <template slot-scope="scope">
                                                        <el-input v-model="scope.row.cost"
                                                            @change="calculatorMainItemChange(scope.row)" size="mini"
                                                            autocomplete="off">

                                                        </el-input>
                                                    </template>
                                                </el-table-column>
                                                <el-table-column prop="currencyCode" label="Currency" width="120">
                                                    <template slot-scope="scope">
                                                        <el-select :loading="loadingAccount"
                                                            v-model="scope.row.currencyCode" clearable filterable
                                                            class="full-width padding-3"
                                                            @change="currencyChanged(scope.row);calculatorMainItemChange(scope.row)"
                                                            size="mini">
                                                            <el-option v-for="option in currenciesList"
                                                                :value="option.code" :label="option.code"
                                                ...
                                                <el-table-column prop="sign" label=" " width="70">
                                                    <template slot-scope="scope">
                                                        <el-input :value="scope.row.currencySymbol" size="mini" disabled
                                                            autocomplete="off" class="font-lg">
                                                ...
                                                <el-table-column prop="discount1" label="Disc1%" width="120">
                                                    <template slot-scope="scope">
                                                        <el-input v-model="scope.row.discount1"
                                                ...
                                                <el-table-column prop="discount2" label="Disc2%" width="120">
                                                    <template slot-scope="scope">
                                                        <el-input v-model="scope.row.discount2"
                                                            @input="handleDecimal(scope.row)"
                                                            @change="calculatorMainItemChange(scope.row)" size="mini"
                                                            autocomplete="off">
                                                ...
                                                <el-table-column prop="costType" label="Cost type " width="120">
                                                    <template slot-scope="scope">
                                                        <el-select v-model="scope.row.costType" clearable filterable
                                                            name="costType" class="full-width padding-3" size="mini">
                                                ...
                                                <el-table-column prop="shipment" label="S&C%" width="120">
                                                    <template slot-scope="scope">
                                                        <el-input @input="handleDecimal(scope.row)"
                                                            @change="calculatorShipmentMarginItemChange(scope.row)"
                                                            v-model="scope.row.shipment" size="mini" autocomplete="off">
                                                ...
                                                <el-table-column prop="landedCost" label="Landed cost" width="120">
                                                    <template slot-scope="scope">
                                                        <el-input v-model="scope.row.landedCost" size="mini" disabled
                                                            autocomplete="off">
                                                ...
                                                <el-table-column prop="sign" label=" " width="70">
                                                    <template>
                                                        <el-input :value="calculationSheetCurrencySymbol" size="mini"
                                                            disabled autocomplete="off" class="font-lg">

                                                        </el-input>
                                                    </template>
                                                </el-table-column>
                                                <el-table-column prop="foc" label="Discount" width="120">
                                                    <template slot-scope="scope">
                                                        <label class="form-checkbox pb-1"></label>
                                                        <input type="checkbox" v-model="scope.row.foc"
                                                            @click="changeFoc(scope.row)" :id="'foc'+scope.$index"
                                                            :name="'foc'+scope.$index" />
                                                    </template>
                                                </el-table-column>
                                                <el-table-column prop="foC_Value" label="Disc %" width="150">
                                                    <template slot-scope="scope">
                                                        <el-input v-model="scope.row.foC_Value"
                                                ...
                                                <el-table-column prop="grossMargin" label="GM%" width="120">
                                                    <template slot-scope="scope">
                                                        <el-input @input="handleDecimal(scope.row)"
                                                            @change="calculatorShipmentMarginItemChange(scope.row)"
                                                            v-model="scope.row.grossMargin" size="mini"
                                                            autocomplete="off">
                                                ...
                                                <el-table-column prop="unitPrice" label="Unit price" width="120">
                                                    <template slot-scope="scope">
                                                        <el-input v-model="scope.row.unitPrice" size="mini" disabled
                                                            autocomplete="off">
                                                ...
                                                <el-table-column prop="amount" label="Total price" width="120">
                                                    <template slot-scope="scope">
                                                        <el-input v-model="scope.row.amount" disabled size="mini"
                                                            autocomplete="off">
                                                ...
                                                <el-table-column prop="Gross margin" label="Gross margin" width="120">
                                                    <template slot-scope="scope">
                                                        <el-input @change="calculatorMainItemChange(scope.row)"
                                                            v-model="scope.row.grossMarginValue" disabled size="mini"
                                                            autocomplete="off">
                                                ...
                                                <el-table-column prop="note" label="Note" width="120">
                                                    <template slot-scope="scope">
                                                        <el-input autocomplete="off" v-model="scope.row.note"
                                                            size="mini">
                                        ...
                                        <b-row class="mt-1">
                                            ...
                                            {{$t('Item')}}
                                                ...
                                                <el-button @click="addNewAlternativeGroup(index)"
                                                    class="btn btn-secondary">
                                                    <span class="fa fa-plus"></span>
                                                    {{ $t("addalternative")}}
                                                </el-button>
                                                ...
                                                <el-button
                                                    @click="ShowDialogToFetchAlternativeItemFromMainConfigs(index)"
                                                    class="btn btn-secondary">{{
                                                    $t('BuildCalculationSheetForAlternative')}}</el-button>


                                            </b-col>
                                            <b-col lg="2">{{$t("TotalLandedCost")}} {{CalcGroup.totalCost | toUSD}}
                                                <strong>{{calculationSheetCode}}</strong></b-col>
                                            <b-col lg="2">{{$t("TotalMargin")}}
                                                {{CalcGroup.totalMargin | toUSD}}
                                                <strong>{{calculationSheetCode}}</strong></b-col>
                                            <b-col lg="2">{{$t("TotalAmount")}} {{CalcGroup.totalAmount | toUSD}}
                                                <strong>{{calculationSheetCode}}</strong></b-col>

                                                <b-col lg="2">{{$t("margin%")}} {{getMargin(CalcGroup.totalMargin,CalcGroup.totalAmount) }}%
                                                </b-col>
                                                <b-col lg="2">{{$t("S&C")}} {{getSC(CalcGroup.totalCost,CalcGroup.totalCostRaw) }}%
                                                </b-col>
                                        ...
                                        <b-row class="mt-1"
                                            v-if="CalcGroup.calculationSheetOptionalGroup && CalcGroup.calculationSheetOptionalGroup.calculationSheetItem.length>0">
                                            <b-col lg="5">
                                        ...
                                        <b-card class="card card-accent-primary mt-0"
                                            v-if="CalcGroup.calculationSheetOptionalGroup">
                                            <div slot="header">
                                                <div class="row">
                                                    <label
                                                        class="col-sm-1 col-md-1 col-xl-1 col-form-label">{{$t("Item")}}-{{index+1}}
                                                    ...
                                                    <div class="row col-md-10 col-lg-10 col-xl-10">
                                                        <div class="col-md-2 col-lg-2 col-xl-2">
                                                            <div class="form-group">
                                                                <label class="col-form-label">{{$t("Currency")}}</label>
                                                                <el-select :loading="loadingAccount"
                                                                    v-model="CalcGroup.calculationSheetOptionalGroup.bulkObj.currencyCode"
                                                                    clearable filterable class="full-width padding-0"
                                                                    size="mini">
                                                                    <el-option v-for="option in currenciesList"
                                                                        :value="option.code" :label="option.code"
                                                                        :key="option.code"></el-option>
                                                        ...
                                                        <div class="col-md-2 col-lg-2 col-xl-2">
                                                            <div class="form-group">
                                                                <label
                                                                    class="col-form-label">{{$t("Discount1")}}</label>
                                                                <el-input
                                                                    v-model="CalcGroup.calculationSheetOptionalGroup.bulkObj.discount1"
                                                                    size="mini" autocomplete="off"></el-input>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2 col-lg-2 col-xl-2">
                                                            <div class="form-group">
                                                                <label
                                                                    class="col-form-label">{{$t("Discount2")}}</label>
                                                                <el-input
                                                                    v-model="CalcGroup.calculationSheetOptionalGroup.bulkObj.discount2"
                                                                    size="mini" autocomplete="off"></el-input>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2 col-lg-2 col-xl-2">
                                                            <div class="form-group">
                                                                <label
                                                                    class="col-form-label">{{$t("ShipmentSG")}}</label>
                                                                <el-input
                                                                    v-model="CalcGroup.calculationSheetOptionalGroup.bulkObj.shipment"
                                                                    size="mini" autocomplete="off"></el-input>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2 col-lg-2 col-xl-2">
                                                            <div class="form-group">
                                                                <label
                                                                    class="col-form-label">{{$t("GrossMargin")}}</label>
                                                                <el-input
                                                                    v-model="CalcGroup.calculationSheetOptionalGroup.bulkObj.grossMargin"
                                                                    size="mini" autocomplete="off"></el-input>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2 col-lg-2 col-xl-2">
                                                            <div class="form-group">
                                                                <label class="col-form-label">{{$t("Quantity")}}</label>
                                                                <el-input
                                                                    v-model="CalcGroup.calculationSheetOptionalGroup.bulkObj.quantity"
                                                                    size="mini" autocomplete="off"></el-input>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2 col-lg-2 col-xl-2">
                                                            <div class="form-group">
                                                                <label class="col-form-label">{{$t("CostType")}}</label>
                                                                <el-select
                                                                    v-model="CalcGroup.calculationSheetOptionalGroup.bulkObj.costType"
                                                                    clearable filterable name="CostType"
                                                                    class="full-width padding-3" size="mini">
                                                                    <el-option v-for="option in costTypeList"
                                            ...
                                            <b-collapse :id="'ItemoptionalGroup-'+index" visible>
                                                <div class="table-responsive-lg table-responsive">
                                                    <el-table class="table-sm table-responsive custom-table"
                                                        ...
                                                        <el-table-column label width="60" fixed>
                                                            <template slot-scope="scope">
                                                                <a class="text-danger"
                                                                    @mousedown="removeOptionalItem(index,scope.row)">
                                                                ...
                                                                &nbsp;
                                                                <a href="javascript:void(0)" class="text-success"
                                                                    @click="duplicateOptionalRow(index,scope.row)">
                                                                    <i class="fa fa-copy"></i>
                                                                </a>
                                                            </template>
                                                        </el-table-column>
                                                        ...
                                                        <el-table-column prop="Name" label="Item code" width="180"
                                                            fixed>
                                                            <template slot-scope="scope">
                                                                <el-select remote reserve-keyword
                                                                    :remote-method="remoteMethodItemsCode"
                                                                    ...
                                                                    <el-option v-for="item in systemItemsList"
                                                                        :key="item.id" :label="item.code"
                                                                        :value="item.code"></el-option>

                                                                </el-select>
                                                            </template>
                                                        </el-table-column>
                                                        <el-table-column prop="Name" label="item description"
                                                            width="280" fixed>
                                                            <template slot-scope="scope">
                                                                <el-select remote reserve-keyword
                                                                    :remote-method="remoteMethodItemsName"
                                                        ...
                                                        <el-table-column prop="onHandPrice" label="OH price"
                                                            width="120">
                                                            <template slot-scope="scope">
                                                                <el-input v-model="scope.row.onHandPrice" size="mini"
                                                                    disabled autocomplete="off">
                                                        ...
                                                        <el-table-column prop="onHandQuantity" label="OH Qty"
                                                            width="120">
                                                            <template slot-scope="scope">
                                                                <el-input v-model="scope.row.onHandQuantity" size="mini"
                                                                    disabled autocomplete="off">
                                                        ...
                                                        <el-table-column prop="currencyCode" label="Currency"
                                                            width="120">
                                                            <template slot-scope="scope">
                                                                <el-select :loading="loadingAccount"
                                                                    v-model="scope.row.currencyCode" clearable
                                                                    filterable class="full-width padding-3"
                                                                    @change="currencyChanged(scope.row);calculatorMainItemChange(scope.row)"
                                                                    size="mini">
                                                        ...
                                                        <el-table-column prop="sign" label=" " width="70">
                                                            <template slot-scope="scope">
                                                                <el-input :value="scope.row.currencySymbol" size="mini"
                                                                    disabled autocomplete="off" class="font-lg">
                                                        ...
                                                        <el-table-column prop="costType" label="Cost type " width="120">
                                                            <template slot-scope="scope">
                                                                <el-select v-model="scope.row.costType" clearable
                                                                    filterable name="costType"
                                                                    class="full-width padding-3" size="mini">
                                                        ...
                                                        <el-table-column prop="shipment" label="S&C%" width="120">
                                                            <template slot-scope="scope">
                                                                <el-input
                                                                    @change="calculatorShipmentMarginItemChange(scope.row)"
                                                                    v-model="scope.row.shipment" size="mini"
                                                                    autocomplete="off">

                                                                </el-input>
                                                            </template>
                                                        </el-table-column>
                                                        <el-table-column prop="landedCost" label="Landed cost"
                                                            width="120">
                                                            <template slot-scope="scope">
                                                                <el-input v-model="scope.row.landedCost" size="mini"
                                                                    disabled autocomplete="off">
                                                        ...
                                                        <el-table-column prop="sign" label=" " width="70">
                                                            <template slot-scope="">
                                                                <el-input :value="calculationSheetCurrencySymbol"
                                                                    size="mini" disabled autocomplete="off"
                                                                    class="font-lg">
                                                        ...
                                                        <el-table-column prop="unitPrice" label="Unit price"
                                                            width="120">
                                                            <template slot-scope="scope">
                                                                <el-input v-model="scope.row.unitPrice" size="mini"
                                                                    disabled autocomplete="off">
                                                        ...
                                                        <el-table-column prop="Gross margin" label="Gross margin"
                                                            width="120">
                                                            <template slot-scope="scope">
                                                                <el-input v-model="scope.row.grossMarginValue" disabled
                                                                    size="mini" autocomplete="off">
                                                ...
                                                {{$t('Item')}}
                                                    ...
                                                    <b-col lg="3">{{$t("TotalLandedCost")}}
                                                        {{CalcGroup.calculationSheetOptionalGroup.totalCost | toUSD}}
                                                        <strong>{{calculationSheetCode}}</strong></b-col>
                                                    <b-col lg="2">{{$t("TotalMargin")}}
                                                        {{CalcGroup.calculationSheetOptionalGroup.totalMargin | toUSD}}
                                                        <strong>{{calculationSheetCode}}</strong></b-col>

                                                    <b-col lg="2">{{$t("TotalAmount")}}
                                                        {{CalcGroup.calculationSheetOptionalGroup.totalAmount | toUSD}}
                                                        <strong>{{calculationSheetCode}}</strong></b-col>

                                                        <b-col lg="2">{{$t("margin%")}} {{getMargin(CalcGroup.calculationSheetOptionalGroup.totalMargin,CalcGroup.calculationSheetOptionalGroup.totalAmount) }}%
                                                        </b-col>
                                                        <b-col lg="2">{{$t("S&C")}} {{getSC(CalcGroup.calculationSheetOptionalGroup.totalCost,CalcGroup.calculationSheetOptionalGroup.totalCostRaw) }}%
                                                        </b-col>
                                        ...
                                        <b-card class="card card-accent-primary mt-60" no-body
                                            ...
                                            <div slot="header">
                                                <div class="row">
                                                    <input type="checkbox" v-model="alternativeGroup.selected"
                                                        style="margin-left: 15px;margin-top: 10px;width: 23px;height: 17px;"
                                                        @click="selectAlternativGroup(alternativeGroupIndex,index)"
                                                    ...
                                                    <div class="row col-md-10 col-lg-10 col-xl-10">
                                                        <div class="col-md-2 col-lg-2 col-xl-2">
                                                            <div class="form-group">
                                                                ...
                                                                <el-input
                                                                    ...
                                                                    v-model="alternativeGroup.name" size="mini"
                                                                    autocomplete="off"></el-input>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-2 col-lg-2 col-xl-2">
                                                            <div class="form-group">
                                                                <label class="col-form-label">{{$t("Currency")}}</label>
                                                                <el-select :loading="loadingAccount"
                                                                    v-model="alternativeGroup.bulkObj.currencyCode"
                                                                    clearable filterable class="full-width padding-0"
                                                                    size="mini">
                                                                    <el-option v-for="option in currenciesList"
                                                                        :value="option.code" :label="option.code"
                                                        ...
                                                        <div class="col-md-2 col-lg-2 col-xl-2">
                                                            <div class="form-group">
                                                                <label
                                                                    class="col-form-label">{{$t("Discount1")}}</label>
                                                                <el-input v-model="alternativeGroup.bulkObj.discount1"
                                                                    size="mini" autocomplete="off"></el-input>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2 col-lg-2 col-xl-2">
                                                            <div class="form-group">
                                                                <label
                                                                    class="col-form-label">{{$t("Discount2")}}</label>
                                                                <el-input v-model="alternativeGroup.bulkObj.discount2"
                                                                    size="mini" autocomplete="off"></el-input>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2 col-lg-2 col-xl-2">
                                                            <div class="form-group">
                                                                <label
                                                                    class="col-form-label">{{$t("ShipmentSG")}}</label>
                                                                <el-input v-model="alternativeGroup.bulkObj.shipment"
                                                                    size="mini" autocomplete="off"></el-input>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2 col-lg-2 col-xl-2">
                                                            <div class="form-group">
                                                                <label
                                                                    class="col-form-label">{{$t("GrossMargin")}}</label>
                                                                <el-input v-model="alternativeGroup.bulkObj.grossMargin"
                                                                    size="mini" autocomplete="off"></el-input>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2 col-lg-2 col-xl-2">
                                                            <div class="form-group">
                                                                <label class="col-form-label">{{$t("Quantity")}}</label>
                                                                <el-input v-model="alternativeGroup.bulkObj.quantity"
                                                                    size="mini" autocomplete="off"></el-input>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2 col-lg-2 col-xl-2">
                                                            <div class="form-group">
                                                                <label class="col-form-label">{{$t("CostType")}}</label>
                                                                <el-select v-model="alternativeGroup.bulkObj.costType"
                                                                    clearable filterable name="CostType"
                                                                    class="full-width padding-3" size="mini">
                                                                    <el-option v-for="option in costTypeList"
                                                                        :value="option.id" :label="option.name"
                                                        ...
                                                        <div class="col-md-2 col-lg-2 col-xl-2">
                                                            <div class="form-group">
                                                                <button type="submit" class="btn btn-success bulk"
                                                                    @click="addBulkAlternativeItems(CalcGroup,alternativeGroupIndex)">
                                                                    <i class="fa fa-plus"></i>
                                                                    {{ $t("bulkUpdate")}}
                                                                </button>
                                                            </div>
                                            ...
                                            <b-collapse :id="'alternativeGroup-'+index+alternativeGroupIndex" visible>
                                                <b-card-body>
                                                    <div class="table-responsive-lg table-responsive">
                                                        ...
                                                        <el-table class="table-sm table-responsive custom-table"
                                                            :data="alternativeGroup.calculationSheetItem" size="mini"
                                                            style="width: 100%">
                                                            ...
                                                            <el-table-column label width="60" fixed>
                                                                <template slot-scope="scope">
                                                                    <a class="text-danger"
                                                                        @mousedown="removeAlternativeItem(index,alternativeGroupIndex,scope.row)">
                                                                        <i class="fa fa-trash"></i>
                                                                    </a>&nbsp;
                                                                    <a href="javascript:void(0)" class="text-success"
                                                                        @click="duplicateAlternativeItem(index,alternativeGroupIndex,scope.row)">
                                                                        <i class="fa fa-copy"></i>
                                                                    </a>
                                                                </template>
                                                            </el-table-column>
                                                            ...
                                                            <el-table-column prop="Name" label="Item code" width="180"
                                                                ...
                                                                <template slot-scope="scope">
                                                                    <el-select remote reserve-keyword
                                                                        ...
                                                                        v-model=" scope.row.code" filterable size="mini"
                                                                        class="full-width padding-3"
                                                                        @change="getItemCodeName(scope.row)">
                                                            ...
                                                            <el-table-column prop="Name" label="item description"
                                                                ...
                                                                <template slot-scope="scope">
                                                                    <el-select remote reserve-keyword
                                                                        :remote-method="remoteMethodItemsName"
                                                                        :loading="loadingAccount"
                                                                        v-model=" scope.row.name" filterable size="mini"
                                                                        class="full-width padding-3"
                                                                        @change="getItemCodeNameByName(scope.row)">
                                                            ...
                                                            <el-table-column prop="vendor" label="Vendor" width="180">
                                                                <template slot-scope="scope">
                                                                    <el-input readonly v-model="scope.row.vendor"
                                                                        disabled size="mini" autocomplete="off">
                                                            ...
                                                            <el-table-column prop="onHandPrice" label="OH price"
                                                                width="120">
                                                                <template slot-scope="scope">
                                                                    <el-input v-model="scope.row.onHandPrice"
                                                                        size="mini" disabled autocomplete="off">
                                    ...
                                    <template slot-scope="scope">
                                        <el-input :value="scope.row.onHandPriceCurrencySymbol" size="mini"  disabled autocomplete="off" class="font-lg">
                                                            ...
                                                            <el-table-column prop="onHandQuantity" label="OH Qty"
                                                                width="120">
                                                                <template slot-scope="scope">
                                                                    <el-input v-model="scope.row.onHandQuantity"
                                                                        size="mini" disabled autocomplete="off">
                                                            ...
                                                            <el-table-column prop="sign" label=" " width="70">
                                                                <template slot-scope="scope">
                                                                    <el-input :value="scope.row.currencySymbol"
                                                                        size="mini" disabled autocomplete="off"
                                                                        class="font-lg">
                                                            ...
                                                            <el-table-column prop="discount1" label="Disc1%"
                                                                width="120">
                                                                <template slot-scope="scope">
                                                                    <el-input v-model="scope.row.discount1"
                                                                        @input="handleDecimal(scope.row)"
                                                            ...
                                                            <el-table-column prop="discount2" label="Disc2%"
                                                                width="120">
                                                                <template slot-scope="scope">
                                                                    <el-input v-model="scope.row.discount2"
                                                                        @input="handleDecimal(scope.row)"
                                                            ...
                                                            <el-table-column prop="costType" label="Cost type "
                                                                width="120">
                                                                <template slot-scope="scope">
                                                                    <el-select v-model="scope.row.costType" clearable
                                                                        filterable name="costType"
                                                            ...
                                                            <el-table-column prop="foC_Value" label="Disc %"
                                                                width="150">
                                                                <template slot-scope="scope">
                                                            ...
                                                            <el-table-column prop="amount" label="Total price"
                                                                width="120">
                                                                <template slot-scope="scope">
                                                                    <el-input v-model="scope.row.amount" size="mini"
                                                                        disabled autocomplete="off">
                                                            ...
                                                            <el-table-column prop="Gross margin" label="Gross margin"
                                                                width="120">
                                                                <template slot-scope="scope">
                                                                    <el-input v-model="scope.row.grossMarginValue"
                                                                        size="mini" disabled autocomplete="off">
                                                            ...
                                                            <el-table-column prop="note" label="Note" width="120">
                                                                <template slot-scope="scope">
                                                                    <el-input autocomplete="off"
                                                                        v-model="scope.row.note" size="mini">
                                    ...
                                    {{$t("Item")}}
                                                            ...
                                                            <el-button
                                                                ...
                                                                v-if="!alternativeGroup.calculationSheetAlternativeOptionalGroup"
                                                                class="btn btn-secondary">
                                                                <span class="fa fa-plus"></span>
                                                                {{ $t("addoptional")}}
                                                            </el-button>
                                                        ...
                                                        <b-col lg="2">{{$t("TotalAmount")}}
                                                            ...
                                                            <b-col lg="2">{{$t("margin%")}} {{getMargin(alternativeGroup.totalMargin,alternativeGroup.totalAmount) }}%
                                                            </b-col>   
                                                            <b-col lg="1">{{$t("S&C")}} {{getSC(alternativeGroup.totalCost,alternativeGroup.totalCostRaw) }}%
                                                            </b-col>
                                                    </b-row>

                                                    <b-row class="mt-1"
                                                        v-if="alternativeGroup.calculationSheetAlternativeOptionalGroup && alternativeGroup.calculationSheetAlternativeOptionalGroup.calculationSheetItem.length > 0">
                                                        <b-col lg="5">
                                                            <el-button
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="row col-md-10 col-lg-10 col-xl-10">
                                                                    <div class="col-md-2 col-lg-2 col-xl-2">
                                                                        <div class="form-group">
                                                                            <label
                                                                                class="col-form-label">{{$t("Currency")}}</label>
                                                                            <el-select :loading="loadingAccount"
                                                                                v-model="alternativeGroup.calculationSheetAlternativeOptionalGroup.bulkObj.currencyCode"
                                                                    ...
                                                                    <div class="col-md-2 col-lg-2 col-xl-2">
                                                                        <div class="form-group">
                                                                            <label
                                                                                class="col-form-label">{{$t("Discount1")}}</label>
                                                                            <el-input
                                                                                v-model="alternativeGroup.calculationSheetAlternativeOptionalGroup.bulkObj.discount1"
                                                                                size="mini"
                                                                                autocomplete="off"></el-input>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-2 col-lg-2 col-xl-2">
                                                                        <div class="form-group">
                                                                            <label
                                                                                class="col-form-label">{{$t("Discount2")}}</label>
                                                                            <el-input
                                                                                v-model="alternativeGroup.calculationSheetAlternativeOptionalGroup.bulkObj.discount2"
                                                                                size="mini"
                                                                                autocomplete="off"></el-input>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-2 col-lg-2 col-xl-2">
                                                                        <div class="form-group">
                                                                            <label
                                                                                class="col-form-label">{{$t("ShipmentSG")}}</label>
                                                                            <el-input
                                                                                v-model="alternativeGroup.calculationSheetAlternativeOptionalGroup.bulkObj.shipment"
                                                                                size="mini"
                                                                                autocomplete="off"></el-input>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-2 col-lg-2 col-xl-2">
                                                                        <div class="form-group">
                                                                            <label
                                                                                class="col-form-label">{{$t("GrossMargin")}}</label>
                                                                            <el-input
                                                                                v-model="alternativeGroup.calculationSheetAlternativeOptionalGroup.bulkObj.grossMargin"
                                                                                size="mini"
                                                                                autocomplete="off"></el-input>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-2 col-lg-2 col-xl-2">
                                                                        <div class="form-group">
                                                                            <label
                                                                                class="col-form-label">{{$t("Quantity")}}</label>
                                                                            <el-input
                                                                                v-model="alternativeGroup.calculationSheetAlternativeOptionalGroup.bulkObj.quantity"
                                                                                size="mini"
                                                                                autocomplete="off"></el-input>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-2 col-lg-2 col-xl-2">
                                                                        <div class="form-group">
                                                                            <label
                                                                                class="col-form-label">{{$t("CostType")}}</label>
                                                                            <el-select
                                                                                v-model="alternativeGroup.calculationSheetAlternativeOptionalGroup.bulkObj.costType"
                                                                                clearable filterable name="CostType"
                                                                                class="full-width padding-3"
                                                                                size="mini">
                                                                                <el-option
                                                                    ...
                                                                    <div class="col-md-2 col-lg-2 col-xl-2">
                                                                        <div class="form-group">
                                                                            <button type="submit"
                                                                                ...
                                                                                @click="addBulkAlternativeOptionalItems(CalcGroup, alternativeGroupIndex)">
                                                                                <i class="fa fa-plus"></i>
                                                                                {{ $t("bulkUpdate")}}
                                                                            </button>
                                                                        </div>
                                                            ...
                                                            <div class="table-responsive-lg table-responsive">
                                                                <el-table class="table-sm table-responsive custom-table"
                                                                    ...
                                                                    <el-table-column label width="60" fixed>
                                                                        <template slot-scope="scope">
                                                                            <a class="text-danger"
                                                                                @mousedown="removeAlternativeOptionalItem(index,alternativeGroupIndex,scope.row)">
                                                                            ...
                                                                            <a href="javascript:void(0)"
                                                                                class="text-success"
                                                                                @click="duplicateAlternativeOptionalItem(index,alternativeGroupIndex,scope.row)">
                                                                                <i class="fa fa-copy"></i>
                                                                            </a>
                                                                        </template>
                                                                    </el-table-column>
                                                                    <el-table-column type="index" width="40"
                                                                        fixed></el-table-column>
                                                                    <el-table-column prop="Name" label="Item code"
                                                                        width="180" fixed>
                                                                        <template slot-scope="scope">
                                                                            <el-select remote reserve-keyword
                                                                                :remote-method="remoteMethodItemsCode"
                                                                                :loading="loadingAccount"
                                                                                v-model=" scope.row.code" filterable
                                                                                size="mini" class="full-width padding-3"
                                                                                @change="getItemCodeName(scope.row)">
                                                                    ...
                                                                    <el-table-column prop="Name"
                                                                        label="item description" width="280" fixed>
                                                                        <template slot-scope="scope">
                                                                            <el-select remote reserve-keyword
                                                                                :remote-method="remoteMethodItemsName"
                                                                                :loading="loadingAccount"
                                                                                v-model=" scope.row.name" filterable
                                                                                size="mini" class="full-width padding-3"
                                                                                @change="getItemCodeNameByName(scope.row)">
                                                                    ...
                                                                    <el-table-column prop="vendor" label="Vendor"
                                                                        ...
                                                                        <template slot-scope="scope">
                                                                            <el-input readonly
                                                                                v-model="scope.row.vendor" disabled
                                                                                size="mini" autocomplete="off">
                                        ...
                                        <template slot-scope="scope">
                                            <el-input :value="scope.row.onHandPriceCurrencySymbol" size="mini"  disabled autocomplete="off" class="font-lg">
                                                                    ...
                                                                    <el-table-column prop="onHandQuantity"
                                                                        label="OH Qty" width="120">
                                                                        <template slot-scope="scope">
                                                                            <el-input v-model="scope.row.onHandQuantity"
                                                                                size="mini" disabled autocomplete="off">
                                                                    ...
                                                                    <el-table-column prop="costType" label="Cost type "
                                                                        width="120">
                                                                        <template slot-scope="scope">
                                                                            <el-select v-model="scope.row.costType"
                                                                                clearable filterable name="costType"
                                                                                class="full-width padding-3"
                                                                                size="mini">
                                                                    ...
                                                                    <el-table-column prop="shipment" label="S&C%"
                                                                        width="120">
                                                                        <template slot-scope="scope">
                                                                            <el-input
                                                                                @change="calculatorShipmentMarginItemChange(scope.row)"
                                                                    ...
                                                                    <el-table-column prop="landedCost"
                                                                        label="Landed cost" width="120">
                                                                        <template slot-scope="scope">
                                                                            <el-input v-model="scope.row.landedCost"
                                                                                size="mini" disabled autocomplete="off">
                                                                    ...
                                                                    <el-table-column prop="foc" label="Discount"
                                                                        width="120">
                                                                        <template slot-scope="scope">
                                                                            <label class="form-checkbox pb-1"></label>
                                                                            <input type="checkbox"
                                                                    ...
                                                                    <el-table-column prop="grossMargin" label="GM%"
                                                                        width="120">
                                                                        <template slot-scope="scope">
                                                                            <el-input @input="handleDecimal(scope.row)"
                                                                                @change="calculatorShipmentMarginItemChange(scope.row)"
                                                                    ...
                                                                    <el-table-column prop="Gross margin"
                                                                        label="Gross margin" width="120">
                                                                        <template slot-scope="scope">
                                                                            <el-input
                                    ...
                                    {{$t('Item')}}
                                                                ...
                                                                <b-col lg="3">{{$t("TotalLandedCost")}}
                                                                    {{alternativeGroup.calculationSheetAlternativeOptionalGroup.totalCost
                                                                    | toUSD}}
                                                                    <strong>{{calculationSheetCode}}</strong></b-col>
                                                                <b-col lg="2">{{$t("TotalMargin")}}
                                                                    {{alternativeGroup.calculationSheetAlternativeOptionalGroup.totalMargin
                                                                    | toUSD}}
                                                                    <strong>{{calculationSheetCode}}</strong></b-col>
                                                                <b-col lg="2">{{$t("TotalAmount")}}
                                                                    {{alternativeGroup.calculationSheetAlternativeOptionalGroup.totalAmount
                                                                    | toUSD}}
                                                                    <strong>{{calculationSheetCode}}</strong></b-col>
                                                                    <b-col lg="2">{{$t("margin%")}} {{getMargin(alternativeGroup.calculationSheetAlternativeOptionalGroup.totalMargin,alternativeGroup.calculationSheetAlternativeOptionalGroup.totalAmount) }}%
                                                                    </b-col>

                                                                    <b-col lg="2">{{$t("S&C")}} {{getSC(alternativeGroup.calculationSheetAlternativeOptionalGroup.totalCost,alternativeGroup.calculationSheetAlternativeOptionalGroup.totalCostRaw) }}%
                                                                    </b-col>
                    ...
                    <b-row>
                        <b-col lg="12" style="padding-bottom: 10px;">
                            <el-button @click="addNewGroup()" class="btn btn-secondary"
                                v-if="calculationSheetGroups.length > 0">
                                <i class="fa fa-plus"></i>
                                {{$t("newGroup")}}
                            </el-button>
                        ...
                        <div class="mb-3" style="border: 1px solid rgb(192, 211, 230);">
                            <div class="row mt-2 mr-1 ml-1">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div>
                                        <el-select remote :remote-method="remoteMethodCurrency"
                                            :loading="loadingAccount"
                                            :disabled="bankGuaranteeDisabled || bankBlockViewModel.bankGuaranteeType == true"
                                            v-model="bankBlockViewModel.currencyCode" clearable filterable
                                            class="full-width">
                                            <el-option v-for="option in currenciesList" :value="option.code"
                                                :label="option.code" :key="option.code"></el-option>
                                        </el-select>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div>
                                        <el-select class="input-custom" v-model="bankBlockViewModel.guaranteeType"
        ...
        <div class="text-center mb-5">
            ...
            <button class="btn csubmit ml-3" v-on:click="saveDataAction(false)"
            ...
            <button class="btn csubmit ml-3" v-on:click="submitCaluctionSheet()" variant="primary"
            ...
            <button class="btn csubmit ml-3" variant="primary"
                v-for="(workflowaction, workflowactionIndex) in workflowStepActionSetting" :key="workflowactionIndex"
        ...
        <el-dialog title="Import excel sheet" :visible="ExcelsheetDialog" :show-close="false"
            :close-on-press-escape="false" :destroy-on-close="false">
            <b-row>
                <b-col sm="12">
                    <b-form-group>
                        <div class="col-md-12 uplaod-btn">
                            <dropzone id="importDropzone" :useCustomSlot="true" :options="dropzoneOptions"
                        ...
                        <div class="mt-2">
                            <strong>{{$t("ExcelHint")}} <a download :href="excelLink" target="_blank">download
                                    template</a></strong>
        ...
        <el-dialog title="Build calculation sheet item dialog" :visible="bulidCalculationSheetDialog"
            :show-close="false" :close-on-press-escape="false" :destroy-on-close="false">
            <b-row>
                <b-col sm="3">
                    <b-form-group :class="{'has-error':errors.has('ItemsGroupValidation.principal')}">
                        ...
                        <label class="required">*</label>
                        <el-select v-on:keyup.enter="getMainConfigByPrincipalCategoryItem()"
                            v-model="ItemsGroupObj.principalId" name="principal" filterable clearable
                            v-bind:placeholder="$t('Select')" v-validate="'required'"
                            data-vv-scope="ItemsGroupValidation"
                            @change="getAllItemsGroupByPrincipleId(ItemsGroupObj.principalId)">
                            <el-option v-for="item in principals" :key="item.code" :label="item.name"
                                :value="item.code"></el-option>
                        </el-select>
                ...
                <b-col sm="3">
                    <b-form-group>
                        ...
                        <el-select v-model="ItemsGroupObj.category" filterable clearable
                            v-bind:placeholder="$t('Select')" v-validate="'required'"
                            data-vv-scope="ItemsGroupValidation" :disabled="!enableCategory"
                            @change="getAllItemsGroupByCategoryId(ItemsGroupObj.category)">
                            <el-option v-for="item in categories" :key="item.category" :label="item.category"
                ...
                <b-col sm="3">
                    <b-form-group>
                        ...
                        <el-select v-model="ItemsGroupObj.model" filterable clearable :placeholder="$t('Select')"
                            v-validate="'required'" :data-vv-as="'model'" data-vv-scope="ItemsGroupValidation"
                            :disabled="!enableModel">
                            <el-option v-for="item in models" :key="item.model" :label="item.model"
                ...
                <b-col sm="3">
                    <b-form-group>
                        ...
                        <el-select v-model="ItemsGroupObj.tenderReference" filterable clearable
                            :placeholder="$t('Select')">
                            <el-option v-for="item in tenderReferences" :key="item.code" :label="item.code"
                                :value="item.code"></el-option>
                        </el-select>

                        <div class="help-block" v-if="errors.has('ItemsGroupValidation.tenderReference')">{{
                            errors.first('ItemsGroupValidation.tenderReference') }}</div>
                    </b-form-group>
                </b-col>
                <b-col sm="3">
                    <b-form-group :class="{'has-error':errors.has('ItemsGroupValidation.principal')}">
                        <el-button style="margin-top: 32px;" type="primary"
                            @click="getMainConfigByPrincipalCategoryItem()">{{$t('Search')}}</el-button>
                    </b-form-group>
                </b-col>
            </b-row>
            <br />
            ...
            <b-row>
                <b-col sm="4" v-for="(mainConfigs, mainConfigsIndex) in mainConfigItems " :key="mainConfigsIndex">
                    <b-card no-body :header="mainConfigs.groupName" footer-tag="footer">
                        <b-list-group flush>
                            <b-list-group-item v-for="(mainConfig, mainConfigIndex) in mainConfigs.itemGroupMainConfig"
                                :key="mainConfigIndex">
            ...
            <span slot="footer" class="dialog-footer">
                <el-button v-if="mainConfigItems.length > 0 && isAlternative" type="primary"
                    @click="extractMainConfigAlternativeGroupItem3()">{{$t('select')}}</el-button>
                <el-button v-else-if="mainConfigItems.length > 0" type="primary"
                    @click="extractMainConfigGroupItem3()">{{$t('select')}}</el-button>
                <el-button @click="closeBuildCalculationSheet()">{{$t("Cancel")}}</el-button>
            </span>
        </el-dialog>

        <el-dialog title="Duplicate group items as" :visible="duplicateGroupDialog" :show-close="false"
            :close-on-press-escape="false" :destroy-on-close="false">
            <b-row>
                <b-col sm="6">
                    <b-form-group :class="{'has-error':errors.has('duplicateGroupValidation.isDuplicateMainGroup')}">
                        ...
                        <label class="required">*</label>
                        <el-select v-model="isDuplicateMainGroup" name="isDuplicateMainGroup" filterable clearable
                            v-bind:placeholder="$t('Select')" v-validate="'required'"
                            data-vv-scope="duplicateGroupValidation" :data-vv-as="$t('Category')">
                            <el-option v-for="item in duplicateGroupList" :key="item.value" :label="item.key"
                                :value="item.value"></el-option>
                        </el-select>
                        <div class="help-block" v-if="errors.has('duplicateGroupValidation.isDuplicateMainGroup')">{{
                            errors.first('duplicateGroupValidation.isDuplicateMainGroup') }}</div>
                    </b-form-group>
                </b-col>
            </b-row>
            <span slot="footer" class="dialog-footer">
                <el-button type="primary" @click="duplicateGroup()">{{$t('select')}}</el-button>
...
export default {
    ...
    computed: {
        calculationSheetCurrencySymbol() {
            return this.currenciesList.length && this.calculationSheetCode ? this.currenciesList.find(x=>x.code==this.calculationSheetCode).currencySymbol : "";
        },
        bankGuaranteeDisabled() {
            let v = !(this.BasicInfoObj.bankGuaranteeLookup && (this.BasicInfoObj.bankGuaranteeLookup.code == 1 ));
            return v;
        },
    },

    created() {
        this.excelLink =  this.$store.getters.serverURI+"ExcelTemplates/calculation_sheet_groups.xlsx"
        ...
        this.$validator.validateAll("duplicateGroupValidation").then(result => {
            if (result) {
                if (this.isDuplicateMainGroup) {
                    var groupToDuplicate = JSON.parse(JSON.stringify(this.calculationSheetGroups[this.groupIndexToDuplicate]));
                    this.calculationSheetGroups.push(groupToDuplicate)
                    this.totalAmountIndex = this.calculationSheetGroups.length - 1;
                }
                else {
                    var mainItemsList = JSON.parse(JSON.stringify(this.calculationSheetGroups[this.groupIndexToDuplicate].calculationSheetItem)),
                        optionalItems = JSON.parse(JSON.stringify(this.calculationSheetGroups[this.groupIndexToDuplicate].calculationSheetOptionalGroup));
                    ...
                    this.calculationSheetGroups[this.groupIndexToDuplicate].selected = false;
                    this.calculationSheetGroups[this.groupIndexToDuplicate].calculationSheetAlternativeGroup.push(
                        {
                            name: "",
                            selected: true,
                            totalAmount: "",
                            totalCost: "",
                            totalMargin: "",
                            calculationSheetMainGroupId: this.calculationSheetGroups[this.groupIndexToDuplicate].id ?
                    ...
                    this.totalAlternativeAmountIndex =
                        this.calculationSheetGroups[this.groupIndexToDuplicate].calculationSheetAlternativeGroup
                        .length - 1;
                }
                ...
                if(row.length){//to skip empty row
                    ...
                    if (row[0]){//to skip total row
                        let calculationSheetItem = {
                            quantity: row[6] || "",
                            cost: row[9] || "0",
                            costType: this.costTypeList.find(x=>x.name==row[10])?this.costTypeList.find(x=>x.name==row[10]).id:14,
                            discount1: row[11] || "",
                            discount2: row[12] || "",
                            currencyCode: row[13] || this.calculationSheetCode,
                            currencySymbol:this.currenciesList.find(x=>x.code==row[13])?this.currenciesList.find(x=>x.code==row[13]).currencySymbol:this.currenciesList.find(x=>x.code==this.calculationSheetCode).currencySymbol,
                            shipment: row[14] || "",
                            landedCost: row[15] || "",
                            grossMargin: row[18] || "",
                            unitPrice: row[20] || "",
                        ...
                        if (row[3]) {
                            ...
                            if (obj) {
                                ...
                                if (!calculationSheetItem.cost) calculationSheetItem.cost = obj.onHandPrice;
                                calculationSheetItem.onHandPriceCurrency = obj.currency
                                calculationSheetItem.onHandPriceCurrencySymbol = obj.currencySymbol
                        ...
                        if (calculationSheetItem.code) {
                            ...
                            if (groupTitle.length==1) {//to add main groups
                                ...
                                let groupObj = this.calculationSheetGroups.find((x, index) => index==groupIndex);
                                if (!groupObj)
                            ...
                            else if (groupTitle[0].split("-")[0]=="Item" && groupTitle[2] == "Alternative" && groupTitle[5] == "Optional")  {//to add optional alternative groups
                                let groupIndex = parseInt(groupTitle[0].split("-")[1])-1;
                                let groupObj = this.calculationSheetGroups[groupIndex];
                                let alternativeGroupIndex = parseInt(groupTitle[3].split("-")[1])-1;
                                let alternativeGroupObj = groupObj.calculationSheetAlternativeGroup.find((x,index)=>index==alternativeGroupIndex)
                                let optionalAlternativeObj = groupObj.calculationSheetAlternativeGroup[alternativeGroupIndex].calculationSheetAlternativeOptionalGroup
                                if (!optionalAlternativeObj)
                                    alternativeGroupObj.calculationSheetAlternativeOptionalGroup = {
                                        ...
                                        totalCost: "",
                                        totalMargin: "",
                                        calculationSheetAlternativeGroupId: alternativeGroupObj.id ? alternativeGroupObj.id : "",
                                        calculationSheetItem: [calculationSheetItem],
                                        bulkObj:{
                                            currencyCode:"",
                                            discount1:"",
                                    ...
                                    alternativeGroupObj.calculationSheetAlternativeOptionalGroup.calculationSheetItem.push(calculationSheetItem);
                                }

                            }
                            else if (groupTitle[0].split("-")[0]=="Item" && groupTitle[2] == "Optional") {//to add optional
                                let groupIndex = parseInt(groupTitle[0].split("-")[1])-1;
                                let groupObj = this.calculationSheetGroups[groupIndex];
                                ...
                                groupObj.calculationSheetOptionalGroup = {
                                    ...
                                    totalCost: "",
                                    totalMargin: "",
                                    calculationSheetMainGroupId: groupObj.id ? groupObj.id : "",
                                    calculationSheetItem: [calculationSheetItem],
                                    bulkObj:{
                                        currencyCode:"",
                                        discount1:"",
                                    ...
                                    groupObj.calculationSheetOptionalGroup.calculationSheetItem.push(calculationSheetItem);
                                }
                            }
                            else {//to add alternative groups
                                let groupIndex = parseInt(groupTitle[0].split("-")[1])-1;
                                let alternativeGroupIndex = parseInt(groupTitle[groupTitle.length-1])-1;
                                let groupObj = this.calculationSheetGroups[groupIndex];
                                let alternativeGroupObj = groupObj.calculationSheetAlternativeGroup.find((x,index)=>index==alternativeGroupIndex)
                                if (!alternativeGroupObj) {
                                    ...
                                    alternativeGroupObj.calculationSheetItem.push(calculationSheetItem);
                                }
    ...
    Excel() {
      ...
      var urlStr =
        ...
        "api/CalculationSheets/"+this.calSheetId+"/Export"
        ...
        if(item.calculationSheetItem && item.calculationSheetItem.length>0){
            ...
            item.calculationSheetItem.forEach((element,index) => {
                if(bulkObj.currencyCode && bulkObj.currencyCode != ""){
                    ...
                    element.currencySymbol=this.currenciesList.filter(x=>x.code==bulkObj.currencyCode)[0].currencySymbol
                }
    ...
    addBulkAlternativeItems(item, indexOfAlternativeGroup){
        ...
        if(item.calculationSheetAlternativeGroup[indexOfAlternativeGroup] &&  
          item.calculationSheetAlternativeGroup[indexOfAlternativeGroup].calculationSheetItem.length > 0 ) {
            let bulkObj = item.calculationSheetAlternativeGroup[indexOfAlternativeGroup].bulkObj;
            item.calculationSheetAlternativeGroup[indexOfAlternativeGroup].calculationSheetItem.forEach((element,index) => {
                if(bulkObj.currencyCode && bulkObj.currencyCode != "")
                   element.currencyCode = bulkObj.currencyCode
                if(bulkObj.discount1 && bulkObj.discount1 != "")
                   element.discount1 = bulkObj.discount1
    ...
    addBulkOptionalItems(item){
        ...
        if(item.calculationSheetOptionalGroup && item.calculationSheetOptionalGroup.calculationSheetItem && item.calculationSheetOptionalGroup.calculationSheetItem.length>0){
            let bulkObj = item.calculationSheetOptionalGroup.bulkObj;
            item.calculationSheetOptionalGroup.calculationSheetItem.forEach((element,index) => {
                if(bulkObj.currencyCode && bulkObj.currencyCode != "")
                   element.currencyCode = bulkObj.currencyCode
                if(bulkObj.discount1 && bulkObj.discount1 != "")
                   element.discount1 = bulkObj.discount1
    ...
    addBulkAlternativeOptionalItems(item , indexOfAlternativeGroup){
        ...
        if(item.calculationSheetAlternativeGroup[indexOfAlternativeGroup] && 
        item.calculationSheetAlternativeGroup[indexOfAlternativeGroup].calculationSheetAlternativeOptionalGroup &&  
        item.calculationSheetAlternativeGroup[indexOfAlternativeGroup].calculationSheetAlternativeOptionalGroup.calculationSheetItem.length > 0 ) {
            let bulkObj = item.calculationSheetAlternativeGroup[indexOfAlternativeGroup].calculationSheetAlternativeOptionalGroup.bulkObj;
            item.calculationSheetAlternativeGroup[indexOfAlternativeGroup].calculationSheetAlternativeOptionalGroup.calculationSheetItem.forEach((element,index) => {
                if(bulkObj.currencyCode && bulkObj.currencyCode != "")
                   element.currencyCode = bulkObj.currencyCode
                if(bulkObj.discount1 && bulkObj.discount1 != "")
                   element.discount1 = bulkObj.discount1
            ...
            item.calculationSheetAlternativeGroup[indexOfAlternativeGroup].calculationSheetAlternativeOptionalGroup.bulkObj={
                currencyCode:"",
                discount1:"",
                discount2:"",
                shipment:"",
    ...
    duplicateAlternativeItem(index,alternativeIndex, rowItem){
        var newObject = JSON.parse(JSON.stringify(rowItem));
        this.calculationSheetGroups[index].calculationSheetAlternativeGroup[alternativeIndex].calculationSheetItem.push(newObject)
    },
    duplicateOptionalRow(index  , rowItem){
        var newObject = JSON.parse(JSON.stringify(rowItem));
        this.calculationSheetGroups[index].calculationSheetOptionalGroup.calculationSheetItem.push(newObject)
    },
    duplicateAlternativeOptionalItem(index,alternativeIndex, rowItem){
        var newObject = JSON.parse(JSON.stringify(rowItem));
        this.calculationSheetGroups[index].calculationSheetAlternativeGroup[alternativeIndex].calculationSheetAlternativeOptionalGroup.calculationSheetItem.push(newObject)
    },
    ...
    remoteMethodItemsName: function(query) {
        ...
        getCurrentStep() {
            ...
            this.$http
                ...
                .then(function(data) {
                    ...
                    this.workflowStepActionSetting = data.body?data.body.workflowStepActionSetting:'';
                });
        },
        ...
        getTotalAmountTotalGrossMarginTotalGrossMarginValue() {
                        ...
                        element.calculationSheetItem.forEach(elm => {
                            ...
                            if(elm.amount != ""){
                                ...
                                if (elm.foC_Value && elm.foC_Value != "" && elm.foC_Value !=0){
                                    ...
                                    let finalTotal = parseFloat(elm.quantity * unitprice).toFixed(3).slice(0,-1);
                                    totalAmountWithoutVat +=  parseFloat(finalTotal)
                                    totalAmount += parseFloat(elm.amount);
                                }
                                else{
                                    let unitprice = parseFloat((elm.landedCost / (1 - parseFloat(elm.grossMargin) / 100))).toFixed(3).slice(0,-1);
                                    let finalTotal = parseFloat(elm.quantity * unitprice).toFixed(3).slice(0,-1);
                                    totalAmountWithoutVat +=  parseFloat(finalTotal)
                                    totalAmount += parseFloat(elm.amount);
                                }
                            ...
                            if(elm.quantity != "" && elm.landedCost != ""){
                                allLandedCost += (parseFloat(elm.landedCost))*parseFloat(elm.quantity)
                            }
                        });
                    }
                } else {
            ...
            this.bankBlockViewModel.totalAmount = Number.isNaN(totalAmount) ? 0.0 : totalAmount.toFixed(3).slice(0,-1);
            this.bankBlockViewModel.totalGrossMarginValue = Number.isNaN(totalGrossMarginValue) ? 0.0 : totalGrossMarginValue.toFixed(3).slice(0,-1);
            ...
            if (parseFloat(totalAmountWithoutVat) > 0) {
                ...
                this.bankBlockViewModel.totalGrossMargin = ((parseFloat(this.bankBlockViewModel.totalGrossMarginValue).toFixed(4) ) / (parseFloat(this.bankBlockViewModel.totalAmount).toFixed(4) / (1+ this.VAT / 100))).toFixed(4);// new change  abdalhadi 21-12-2023.
            } else {
        ...
        getAmountsForMainAndAlternative() {
            ...
            if (val[this.totalAmountIndex]) {
                val[this.totalAmountIndex].calculationSheetItem.forEach(function(_val) {
        ...
        getRemoteItemsByName(qurey) {
            ...
            var urlStr =
                this.$store.getters.serverURI + "api/Item/GetAllItems?name=" + qurey+"&department=ME";
        ...
        getRemoteItemsByCode(qurey) {
            this.loadingFetchdata = true;
            var urlStr =
                this.$store.getters.serverURI + "api/Item/GetAllItems?code=" + qurey+"&department=ME";
            this.$http
                .get(urlStr, {
                    headers: this.$store.getters.tokenAuthonticationHeaderObj
                })
        ...
        calculatorMainItemChange(rowItem) {
            ...
            // if (rowItem.cost && rowItem.landedCost) {
                if(rowItem.foC_Value && rowItem.foC_Value != "" && rowItem.foC_Value != 0){
                    var unitPrice = ((rowItem.landedCost / (1 - parseFloat(grossMargin) / 100) * (1 - parseFloat(fOCValue) / 100)) ).toFixed(3).slice(0,-1);

                    rowItem.unitPrice = unitPrice
                    if (this.isVat == true) {
                        rowItem.unitPrice = (parseFloat(unitPrice).toFixed(3).slice(0,-1) * (1 + parseFloat(this.VAT / 100))).toFixed(3).slice(0,-1);
                    }
                    let newUnitPrice = parseFloat(rowItem.landedCost * (1 - parseFloat(fOCValue) / 100) / (1 - parseFloat(grossMargin) / 100)).toFixed(3).slice(0,-1);
                    rowItem.grossMarginValue = parseFloat((( parseFloat(newUnitPrice) - parseFloat(rowItem.landedCost) ) * parseFloat(quantity))).toFixed(3).slice(0,-1);
                    ...
                    var unitPrice = ((rowItem.landedCost / (1 - parseFloat(grossMargin) / 100)) ).toFixed(3).slice(0,-1);

                    rowItem.unitPrice = unitPrice
                    if (this.isVat == true) {
                        rowItem.unitPrice = (parseFloat(unitPrice).toFixed(3).slice(0,-1) * (1 + parseFloat(this.VAT / 100))).toFixed(3).slice(0,-1);
                    }
                    let newUnitPrice = parseFloat(rowItem.landedCost / (1 - parseFloat(grossMargin) / 100)).toFixed(3).slice(0,-1);
                    rowItem.grossMarginValue = parseFloat((( parseFloat(newUnitPrice) - parseFloat(rowItem.landedCost) ) * parseFloat(quantity))).toFixed(3).slice(0,-1);
                    // rowItem.grossMarginValue =( (rowItem.unitPrice / (1 + parseFloat(this.VAT / 100)) - parseFloat(rowItem.landedCost))
                    //  * parseFloat(quantity)).toFixed(3).slice(0,-1);
                }
            ...
            // if (rowItem.unitPrice) {
                rowItem.amount = parseFloat(quantity * rowItem.unitPrice).toFixed(3).slice(0,-1);
                // let unitPrice = (
                ...
                .then(
                    function(data) {
                        ...
                        if (data.body.calculationSheetMainGroup.length) {
                            this.calculationSheetGroups = data.body.calculationSheetMainGroup.map(element => { 
                                element.bulkObj = {
                                    currencyCode:"",
                                    discount1:"",
                                    discount2:"",
                                ...
                                if (element.calculationSheetOptionalGroup) element.calculationSheetOptionalGroup.bulkObj = {
                                    currencyCode:"",
                                    discount1:"",
                                    discount2:"",
                                    shipment:"",
                                ...
                                element.calculationSheetAlternativeGroup = element.calculationSheetAlternativeGroup.map(alter => {
                                    alter.bulkObj={
                                        currencyCode:"",
                                        discount1:"",
                                        discount2:"",
                                    ...
                                    if (alter.calculationSheetAlternativeOptionalGroup) alter.calculationSheetAlternativeOptionalGroup.bulkObj = {
                                        currencyCode:"",
                                        discount1:"",
                                        discount2:"",
                                        shipment:"",
      ...
      this.$http
        ...
        addNewMainSheetItem(index) {
            ...
            this.calculationSheetGroups[index].calculationSheetItem.push({
                ...
                currencySymbol:this.currenciesList.filter(x=>x.code==this.calculationSheetCode)[0].currencySymbol,
                shipment: "",
                landedCost: "",
                foc: false,
                foC_Value: "",
      ...
      if (query !== "") {
        ...
        removeSingleOptionalGroup(index) {
            ...
            this.$msgbox({
                ...
                beforeClose: (action, instance, done) => {
                if (action === "confirm") {
                    this.calculationSheetGroups[index].calculationSheetOptionalGroup = null;
                    done();
                } else {
                    done();
                 }
        ...
        removeCalcuationSheetMainItems(index, item) {
            ...
            this.$msgbox({
                ...
                if (action === "confirm") {
                    ...
                    this.calculationSheetGroups[index].calculationSheetItem.indexOf(item),
                    1);
        ...
        removeAlternativeOptionalItem(index, alternativeGroupIndex, item) {
            ...
            this.$msgbox({
                ...
                beforeClose: (action, instance, done) => {
                if (action === "confirm") {
                   this.calculationSheetGroups[index].calculationSheetAlternativeGroup[  alternativeGroupIndex ].calculationSheetAlternativeOptionalGroup.calculationSheetItem.splice(
                this.calculationSheetGroups[index].calculationSheetAlternativeGroup[
                    alternativeGroupIndex
        ...
        getMargin(totalMargin,totalAmount){
           return totalAmount == 0 ? 0 :((totalMargin/totalAmount)*100).toFixed(3)
        },
        getSC(totalLandingCost,totalCost){
           return totalCost == 0 ? 0 :((totalLandingCost/totalCost)*100).toFixed(3)
        },
                                ...
                                if (val == MainConfigGroup.id) {
                                    MainConfigGroup.itemGroupOptionalItem.map(function(value) {
                                        var item = {
                                            ...
                                            currencySymbol:vm.currenciesList.filter(x=>x.code==vm.calculationSheetCode)[0].currencySymbol,
                                            shipment: "",
                                            landedCost: "",
                                            foc: false,
                                            foC_Value: "",
        ...
        extractMainConfigGroupItem() {
            ...
            var calculationSheetGroups = this.calculationSheetGroups[
                ...
                if (element) {
                    if (element.selected == true) {
                        ...
                        element.calculationSheetAlternativeGroup.forEach(alterElement => {
                            if (alterElement.selected == true) {
                                if (element.calculationSheetItem.length > 0) {
                                    alterElement.calculationSheetItem.forEach(
                                        (_element) => {
                                            if ( _element.name == "" ) {
                                                isValidArr.push(false);
                                                this.$message({
        ...
        var val = this.calculationSheetGroups;
           if (val && val.length > 0) {
                val.forEach((element) => {
                    ...
                    element.totalCost = Number.isNaN(LandingCost) ? 0.0 : LandingCost.toFixed(3).slice(0,-1);
                    element.totalMargin = Number.isNaN(Margin) ?
                        0.0 :
                        Margin.toFixed(3).slice(0,-1);

                    element.totalCostRaw = Number.isNaN(Cost) ? 0.0 : Cost.toFixed(3).slice(0,-1);
                    ...
                    element.calculationSheetAlternativeGroup.forEach(alterElement => {
                        ...
                        alterElement.totalCost = Number.isNaN(AlternativeLandingCost) ? 0.0 : AlternativeLandingCost.toFixed(3).slice(0,-1);
                        alterElement.totalMargin = Number.isNaN(AlternativeMargin) ? 0.0 : AlternativeMargin.toFixed(3).slice(0,-1);
                        alterElement.totalCostRaw = Number.isNaN(AlternativeCost) ? 0.0 : AlternativeCost.toFixed(3).slice(0,-1);
                        ...
                        if (
                            ...
                            alterElement.calculationSheetAlternativeOptionalGroup.calculationSheetItem.forEach(
                                ...
                                if(_elementOptional.landedCost != "" && _elementOptional.quantity != ""){
                                    ...
                                    if(_elementOptional.cost != ""){
                                        AlternativeOptionalCost += parseFloat(_elementOptional.cost);
                                    }
                                }
                            );
                            ...
                            alterElement.calculationSheetAlternativeOptionalGroup.totalMargin = Number.isNaN(
                                ...
                                alterElement.calculationSheetAlternativeOptionalGroup.totalCostRaw = Number.isNaN(  AlternativeOptionalCost  ) ?  0.0 :  AlternativeOptionalCost.toFixed(3).slice(0,-1);
                        }
                    });
                    ...
                    if (element.calculationSheetOptionalGroup) {
                        ...
                        element.calculationSheetOptionalGroup.totalMargin = Number.isNaN(
                            ...
                            element.calculationSheetOptionalGroup.totalCostRaw = Number.isNaN( OptionalCost  ) ?  0.0 : OptionalCost.toFixed(3).slice(0,-1);
                    }
                });
            }
       },
       deleteSelectedForCalcuationSheetMainItems(index){
        if(!this.calculationSheetGroups[index].calculationSheetItem || this.calculationSheetGroups[index].calculationSheetItem.length ==0)
            return;
        ...
        const h = this.$createElement;
            this.$msgbox({
                ...
                if (action === "confirm") {
                     ...
                     this.$set( this.calculationSheetGroups[index], "calculationSheetItem",  this.calculationSheetGroups[index].calculationSheetItem.filter(  item => !item.selected ) );
       ...
       deleteSelectedForCalcuationSheetOptionalGroupItems(index){
        if(!this.calculationSheetGroups[index].calculationSheetOptionalGroup.calculationSheetItem || this.calculationSheetGroups[index].calculationSheetOptionalGroup.calculationSheetItem.length ==0)
            return;
        ...
        const h = this.$createElement;
            this.$msgbox({
                ...
                if (action === "confirm") {
                     // Filter out selected items without using splice directly
                     this.$set( this.calculationSheetGroups[index].calculationSheetOptionalGroup, "calculationSheetItem",  this.calculationSheetGroups[index].calculationSheetOptionalGroup.calculationSheetItem.filter(  item => !item.selected ) );
       ...
       deleteSelectedForCalcuationSheetAlternativeOptionalItem(index,alternativeGroupIndex){
        ...
        if(!this.calculationSheetGroups[index].calculationSheetAlternativeGroup[  alternativeGroupIndex ].calculationSheetAlternativeOptionalGroup.calculationSheetItem || 
        this.calculationSheetGroups[index].calculationSheetAlternativeGroup[  alternativeGroupIndex ].calculationSheetAlternativeOptionalGroup.calculationSheetItem.length ==0)
            return;
        ...
        const h = this.$createElement;
            this.$msgbox({
                ...
                if (action === "confirm") {
                     ...
                     // Filter out selected items without using splice directly
                     this.$set( this.calculationSheetGroups[index].calculationSheetAlternativeGroup[alternativeGroupIndex].calculationSheetAlternativeOptionalGroup, "calculationSheetItem",  
                     this.calculationSheetGroups[index].calculationSheetAlternativeGroup[alternativeGroupIndex].calculationSheetAlternativeOptionalGroup.calculationSheetItem.filter(  item => !item.selected ) );
       ...
       deleteSelectedForCalcuationSheetAlternativeItem(index,alternativeGroupIndex){
        ...
        if(! this.calculationSheetGroups[index].calculationSheetAlternativeGroup[ alternativeGroupIndex ].calculationSheetItem || 
        this.calculationSheetGroups[index].calculationSheetAlternativeGroup[ alternativeGroupIndex ].calculationSheetItem.length ==0)
            return;
        ...
        const h = this.$createElement;
            this.$msgbox({
                ...
                if (action === "confirm") {
                     ...
                     this.$set( this.calculationSheetGroups[index].calculationSheetAlternativeGroup[ alternativeGroupIndex ], "calculationSheetItem", 
                     this.calculationSheetGroups[index].calculationSheetAlternativeGroup[ alternativeGroupIndex ].calculationSheetItem.filter(  item => !item.selected ) );
