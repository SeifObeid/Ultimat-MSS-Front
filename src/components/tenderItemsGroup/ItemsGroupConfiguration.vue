  ...
  >
    ...
    <b-collapse id="collapse1" visible>
      <b-card-body>
        <div class="row">
          <div class="col-md-12">
            <router-link :to="{ name: 'tenderItemsGroupList'}" class="btn btn-secondary">
...
export default {
  ...
  methods: {
    ...
    getPrincipalNames() {
      var urlStr =
        this.$store.getters.serverURI + "api/TenderItemsGroup/GetItemPrinicipals";
    ...
    getCategoryNames() {
      var urlStr =
        this.$store.getters.serverURI +
        "api/TenderItemsGroup/GetAllItemCategories/" +
        this.ItemsGroupObj.principalCode;
    ...
    getModelNames() {
      var urlStr =
        this.$store.getters.serverURI +
        "api/TenderItemsGroup/GetAllItemModels/" +
    ...
    addItemsGroup() {
      this.$validator.validateAll("ItemsGroupValidation").then(result => {
        if (result) {
          ...
          var urlStr = this.$store.getters.serverURI + "api/TenderItemsGroup";
            ...
            this.$http
              ...
              .then(
                response => {
                  ...
                  this.clearAll();
                  this.$router.push({
                    path: "/tender-items-group/ItemsGroupList"
                  });
                },
    ...
    getItemsGroupFromService: function() {
      this.fullscreenLoading = true;
      var urlStr =
        this.$store.getters.serverURI + "api/TenderItemsGroup/" + this.GroupId;
