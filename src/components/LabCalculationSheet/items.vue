        ...
        <b-card class="card card-accent-primary" no-body>
            ...
            <b-collapse id="collapse1" visible>
                <b-card-body>
                    ...
                    <b-row v-for="(CalcGroup,index) in tenderCalculationSheetGroups" :key="index">
                                ...
                                <b-collapse :id="'mainItem-'+index" visible>
                                    <b-card-body>
                                        <div class="table-responsive-lg table-responsive">
                                            <el-table class="table-sm table-responsive custom-table" :data="CalcGroup.labCalculationSheetItem" size="mini" style="width: 100%">
                                            ...
                                            <el-table-column label width="50" fixed>
                                                ...
                                                <el-table-column prop="Name" label="Item Code" width="180" fixed>
                                                    <template slot-scope="scope">
                                                        <el-select remote
                                                            ...
                                                            :loading="loadingAccount" v-model=" scope.row.code" filterable  size="mini" class="full-width padding-3" @change="getItemCodeName(scope.row)">
                                                            <el-option v-for="item in systemItemsList" :key="item.id" :label="item.code" :value="item.code"></el-option>
                                                        </el-select>
                                                    </template>
                                                </el-table-column>
                                                <el-table-column prop="Name" label="MSS Name" width="280" fixed>
                                                    <template slot-scope="scope">
                                                        <el-select      remote
                                                            ...
                                                            :loading="loadingAccount" v-model=" scope.row.name" filterable  size="mini" class="full-width padding-3" @change="getItemCodeNameByName(scope.row)">
                                                            <el-option v-for="item in systemItemsList" :key="item.id" :label="item.name" :value="item.name"></el-option>
                                                        </el-select>
                                                    </template>
                                                </el-table-column>
                                                ...
                                                <el-table-column prop="costType" label="Cost type " width="120">
                                                    <template slot-scope="scope">
                                                        <el-select v-model="scope.row.costType"   clearable filterable name="costType" class="full-width padding-3" size="mini">
                                                ...
                                                <el-table-column prop="msS_Unit" label="MSS Unit" width="120">
                                                    <template slot-scope="scope">
                                                        <el-select
                                                            ...
                                                            class="full-width padding-3"
                                                            size="mini">
                                                            <el-option v-for="option in mssUnitList" :value="option.value" :label="option.name" :key="option.value"></el-option>
                                                        </el-select>
                                                    </template>
                                                </el-table-column>
                                                ...
                                                <el-table-column prop="shipment" label="S&C%" width="120">
                                                    <template slot-scope="scope">
                                                        <el-input @input="handleDecimal(scope.row)" @change="calculatorShipmentMarginItemChange(scope.row)" v-model="scope.row.shipment" size="mini" autocomplete="off">
                                                        </el-input>
                                                    </template>
                                                </el-table-column>
                                                <el-table-column prop="landedCostInSelectedCurrency" label="Landed cost in selected currency" width="210">
                                                    <template slot-scope="scope">
                                                        <el-input     v-model="scope.row.landedCostInSelectedCurrency" size="mini" disabled autocomplete="off">
                                                        </el-input>
                                                    </template>
                                                </el-table-column>
                                                <el-table-column prop="sign" label=" " width="70">
                                                ...
                                                <el-table-column prop="sign" label=" " width="70">
                                                    <template slot-scope="">
                                                        <el-input :value="calculationSheetCurrencySymbol" size="mini"  disabled autocomplete="off" class="font-lg">
                                                        </el-input>
                                                    </template>
                                                </el-table-column>
                                                <el-table-column
                                                ...
                                                >
                                                    <template slot-scope="scope">
                                                        <el-input  v-model="scope.row.totalLandedCost" size="mini" disabled autocomplete="off">
                                                        </el-input>
                                                    </template>
                                                </el-table-column>
                                                <el-table-column prop="sign" label=" " width="70">
                                                ...
                                                <el-table-column prop="totalLandedCostInSelectedCurrency" label="Total landed cost in selected currency" width="130">
                                                <template slot-scope="scope">
                                                <el-input     v-model="scope.row.totalLandedCostInSelectedCurrency" size="mini" disabled autocomplete="off">
                                                </el-input>
                                                </template>
                                                </el-table-column>
                                                <el-table-column prop="sign" label=" " width="70">
                                                ...
                                                <el-table-column prop="grossMargin" label="GM%" width="120">
                                                    <template slot-scope="scope">
                                                        <el-input disabled v-model="scope.row.grossMargin" size="mini" autocomplete="off">
                                                        </el-input>
                                                    </template>
                                                </el-table-column>
                                                <el-table-column prop="quotationSupplier_WithOut_Vat" label="Quotation P./Supplier (without VAT)" width="150">
                                                    <template slot-scope="scope">
                                                        <el-input  disabled @change="calculatorShipmentMarginItemChange(scope.row)" v-model="scope.row.quotationSupplier_WithOut_Vat" size="mini" autocomplete="off">
                                                        </el-input>
                                                    </template>
                                                </el-table-column>
                                                <el-table-column prop="sign" label=" " width="70">
                                                ...
                                                <el-table-column prop="quotationSupplier_With_Vat" label="Quotation P./Supplier (with VAT)" width="150">
                                                    <template slot-scope="scope">
                                                        <el-input     v-model="scope.row.quotationSupplier_With_Vat" size="mini" disabled autocomplete="off">
                                                        </el-input>
                                                    </template>
                                                </el-table-column>
                                                <el-table-column prop="sign" label=" " width="70">
                                                ...
                                                <el-table-column prop="finalUnitPrice" label="Final unit price" width="120">
                                                    <template slot-scope="scope">
                                                        <el-input  @change="calculatorShipmentMarginItemChange(scope.row)"    v-model="scope.row.finalUnitPrice" size="mini" autocomplete="off">
                                                        </el-input>
                                                    </template>
                                                </el-table-column>
                                                <el-table-column prop="sign" label=" " width="70">
                                                ...
                                                <el-table-column prop="totalQuotationPrice" label="Total amount" width="120">
                                                    <template slot-scope="scope">
                                                        <el-input   v-model="scope.row.totalQuotationPrice" disabled size="mini" autocomplete="off">
                                                        </el-input>
                                                    </template>
                                                </el-table-column>
                                                <el-table-column prop="sign" label=" " width="70">
                                        ...
                                        <b-row class="mt-1">
                                            <b-col lg="4">
                                                <el-button
                                                v-if=" CalcGroup.labCalculationSheetAlternativeGroup.length > 0 "
                                                ...
                                                <b-row class="mt-1"
                                                    v-if="CalcGroup.labCalculationSheetOptionalGroup && CalcGroup.labCalculationSheetOptionalGroup.labCalculationSheetItem.length>=0">
                                                    <b-col lg="5">
                                            ...
                                            <b-col lg="2">{{$t('totalIn',{currency: tenderCalculationSheetCode})}} 
                                                {{CalcGroup.groupTotalQuotationPrice | toUSD}}
                                                <strong>{{tenderCalculationSheetCode}}</strong>
                                            </b-col>
                                            <b-col lg="2">
                                                {{$t('totalInCurrencyWithoutVat',{currency: tenderCalculationSheetCode})}} 
                                            ...
                                            <b-col lg="2">{{$t('grossMargin',{currency: tenderCalculationSheetCode})}}
                                        ...
                                        <b-collapse :id="'ItemoptionalGroup-'+index" visible>
                                            ...
                                            <!-- seif options -->
                                            <b-col lg="2">{{$t('totalIn',{currency: tenderCalculationSheetCode})}} {{CalcGroup.labCalculationSheetOptionalGroup.groupTotalQuotationPrice | toUSD}}
                                                <strong>{{tenderCalculationSheetCode}}</strong>
                                            </b-col>
                                            <b-col lg="2">
                                                {{$t('totalInCurrencyWithoutVat',{currency: tenderCalculationSheetCode})}} {{CalcGroup.labCalculationSheetOptionalGroup.groupTotal_WO_VAT | toUSD}}
                                                <strong>{{tenderCalculationSheetCode}}</strong>
                                            </b-col>
                                            <b-col lg="2">{{$t('margin%')}} {{CalcGroup.labCalculationSheetOptionalGroup.totalMargin | toUSD}} %</b-col>
                                            <b-col lg="2">{{$t('grossMargin',{currency: tenderCalculationSheetCode})}}
                                                 {{CalcGroup.labCalculationSheetOptionalGroup.totalGrossMarginValue | toUSD}}
                                                <strong>{{tenderCalculationSheetCode}}</strong>
                                            </b-col>
                                            </b-row>
                                        </b-collapse>
                                        ...
                                        <div slot="header">
                                            ...
                                            >{{ $t('AlternativeGroup')}} {{ alternativeGroupIndex+1}}
                                            </label>
                                        ...
                                        <b-collapse :id="'alternativeGroup-'+index+alternativeGroupIndex" visible>
                                            ...
                                            <b-row class="mt-1">
                                                ...
                                                <b-col lg="2">{{$t('totalIn',{currency: tenderCalculationSheetCode})}} {{alternativeGroup.groupTotalQuotationPrice | toUSD}}
                                                    <strong>{{tenderCalculationSheetCode}}</strong>
                                                </b-col>
                                                <b-col lg="2">
                                                    {{$t('totalInCurrencyWithoutVat',{currency: tenderCalculationSheetCode})}} {{alternativeGroup.groupTotal_WO_VAT | toUSD}}
                                                    <strong>{{tenderCalculationSheetCode}}</strong>
                                                </b-col>
                                                <b-col lg="2">{{$t('margin%')}} {{alternativeGroup.totalMargin | toUSD}} %</b-col>
                                                <b-col lg="2">{{$t('grossMargin',{currency: tenderCalculationSheetCode})}}
                                            ...
                                            <el-button
                                                ...
                                                v-if="!alternativeGroup.labCalculationSheetAlternativeOptionalGroup"
                                                class="btn btn-secondary">
                                                <span class="fa fa-plus"></span>
                                                {{ $t("addoptional")}}
                                            </el-button>
                                            <b-card
                                                class="card card-accent-primary mt-3"
                                                v-if="alternativeGroup.labCalculationSheetAlternativeOptionalGroup != null"
                                            >
                                                <div slot="header">
                                                ...
                                                <div class="table-responsive-lg table-responsive">
                                                    <el-table
                                                    class="table-sm table-responsive custom-table"
                                                    :data="alternativeGroup.labCalculationSheetAlternativeOptionalGroup.labCalculationSheetItem"
                                                    size="mini"
                                                    style="width: 100%"
                                                    >
                                                        <el-table-column label width="50" fixed>
                                                ...
                                                <b-row class="mt-1">
                                                    ...
                                                    <b-col lg="2">{{$t('totalIn',{currency: tenderCalculationSheetCode})}} {{alternativeGroup.labCalculationSheetAlternativeOptionalGroup.groupTotalQuotationPrice | toUSD}}
                                                        {{tenderCalculationSheetCode}}
                                                    </b-col>
                                                    <b-col lg="2">
                                                        {{$t('totalInCurrencyWithoutVat',{currency: tenderCalculationSheetCode})}} {{alternativeGroup.labCalculationSheetAlternativeOptionalGroup.groupTotal_WO_VAT | toUSD}}
                                                        <strong>{{tenderCalculationSheetCode}}</strong>
                                                    </b-col>
                                                    <b-col lg="2">{{$t('margin%')}} {{alternativeGroup.labCalculationSheetAlternativeOptionalGroup.totalMargin | toUSD}} %</b-col>
                                                    <b-col lg="2">{{$t('grossMargin',{currency: tenderCalculationSheetCode})}} 
                                                        {{alternativeGroup.labCalculationSheetAlternativeOptionalGroup.totalGrossMarginValue | toUSD}}
                                                        <strong>{{tenderCalculationSheetCode}}</strong>
                                                    </b-col>
                                                </b-row>
                                                </b-collapse>
                    ...
                    <div class="mt-2">
                        ...
                        <div class="row mb-2 mt-4 mr-1 ml-1">
                            <div class="col-md-3">
                            <div>{{$t("totalIn",{currency: tenderCalculationSheetCode})}}</div>
                            <div>
                                <label>
                            ...
                            <div class="col-md-3">
                            <div>
                                {{$t("totalInCurrencyWithoutVat",{currency: tenderCalculationSheetCode})}}</div>
                            <div>
                                <label>
                            ...
                            <div class="col-md-3">
                            <div>{{$t("grossMargin",{currency: tenderCalculationSheetCode})}}</div>
                            <div>
                                <label>
...
export default {
    ...
    computed: {
        ...
        calculationSheetCurrencySymbol() {
            return this.currenciesList.length && this.tenderCalculationSheetCode ? this.currenciesList.find(x=>x.code==this.tenderCalculationSheetCode).currencySymbol : "";
        }
    },
    created() {
        this.excelLink =  this.$store.getters.serverURI+"ExcelTemplates/LabCalculationSheetItemsTemplete.xlsx"
    ...
    methods: {
            ...
            this.$validator.validateAll("duplicateGroupValidation").then(result => {
                if (result) {
                    if (this.isDuplicateMainGroup) {
                        ...
                        var mainItemsList = JSON.parse(JSON.stringify(this.tenderCalculationSheetGroups[this.groupIndexToDuplicate].labCalculationSheetItem)),
                            optionalItems = JSON.parse(JSON.stringify(this.tenderCalculationSheetGroups[this.groupIndexToDuplicate].labCalculationSheetOptionalGroup));
                        let labCalculationSheetAlternativeGroup = JSON.parse(JSON.stringify(this.labCalculationSheetAlternativeGroup));
                        labCalculationSheetAlternativeGroup.labCalculationSheetMainGroupId = this.tenderCalculationSheetGroups[this.groupIndexToDuplicate].id ?
                                    this.tenderCalculationSheetGroups[this.groupIndexToDuplicate].id :
                                    "";
                        labCalculationSheetAlternativeGroup.labCalculationSheetItem = mainItemsList;
                        labCalculationSheetAlternativeGroup.labCalculationSheetAlternativeOptionalGroup = optionalItems;
                        this.tenderCalculationSheetGroups[this.groupIndexToDuplicate].labCalculationSheetAlternativeGroup.push(labCalculationSheetAlternativeGroup);
                        this.totalAlternativeAmountIndex =
                            this.tenderCalculationSheetGroups[this.groupIndexToDuplicate].labCalculationSheetAlternativeGroup
                            .length - 1;
                    }
        ...
        calculateTotal() {
            ...
            if (val && val.length > 0) {
                val.forEach((element) => {
                    ...
                    element.groupTotal_WO_VAT=(element.groupTotalQuotationPrice /(1+vatValue/100)).toFixed(3);
                    element.totalLandedCost = Number.isNaN(_groupTotalLandedCost) ? 0.0 : _groupTotalLandedCost.toFixed(3)//.slice(0,-1);                             
                    element.totalMargin = (Number.isNaN((element.groupTotal_WO_VAT-element.totalLandedCost)/element.groupTotal_WO_VAT) || element.groupTotal_WO_VAT==0) ? 0.0 
                    : (((element.groupTotal_WO_VAT-element.totalLandedCost)/element.groupTotal_WO_VAT)*100).toFixed(3);
                    //element.totalGrossMarginValue =  Number.isNaN(_totalGrossMarginValue) ? 0.0 : (_totalGrossMarginValue).toFixed(3);
                    element.totalGrossMarginValue =  (element.groupTotal_WO_VAT - element.totalLandedCost ).toFixed(3);
                    
                    

                    element.labCalculationSheetAlternativeGroup.forEach(alterElement => {
                        ...
                        alterElement.labCalculationSheetItem.forEach((_element) => {
                            if(_element.totalLandedCost != ""){
                                _AlternativeGroupTotalLandedCost += parseFloat(_element.totalLandedCost);
                            }
                            if(_element.total_WO_VAT != ""){
                        ...
                        alterElement.groupTotal_WO_VAT=(alterElement.groupTotalQuotationPrice /(1+vatValue/100)).toFixed(3);
                        
                        alterElement.totalLandedCost = Number.isNaN(_AlternativeGroupTotalLandedCost) ? 0.0 : _AlternativeGroupTotalLandedCost.toFixed(3)//.slice(0,-1);							 
                        alterElement.totalMargin = (Number.isNaN((alterElement.groupTotal_WO_VAT-alterElement.totalLandedCost)/alterElement.groupTotal_WO_VAT) || alterElement.groupTotal_WO_VAT==0 ) ? 0.0 : (((alterElement.groupTotal_WO_VAT-alterElement.totalLandedCost)/alterElement.groupTotal_WO_VAT)*100).toFixed(3)//.slice(0,-1);
                        alterElement.totalGrossMarginValue = Number.isNaN(alterElement.groupTotal_WO_VAT-alterElement.totalLandedCost) ? 0.0 : (alterElement.groupTotal_WO_VAT-alterElement.totalLandedCost).toFixed(3)//.slice(0,-1);
                        if (
                            ...
                            (_elementOptional) => {
                                if(_elementOptional.totalLandedCost != ""){
                                    _AlternativeOptionalGroupTotalLandedCost += parseFloat(_elementOptional.totalLandedCost);
                                }
                            ...
                            alterElement.labCalculationSheetAlternativeOptionalGroup.groupTotalQuotationPrice = Number.isNaN(_AlternativeOptionalGroupTotalQuotationPrice) ? 0.0 : _AlternativeOptionalGroupTotalQuotationPrice.toFixed(3)//.slice(0,-1);							 
                            alterElement.labCalculationSheetAlternativeOptionalGroup.groupTotal_WO_VAT = 
                            (alterElement.labCalculationSheetAlternativeOptionalGroup.groupTotalQuotationPrice /(1+vatValue/100)).toFixed(3);
                            alterElement.labCalculationSheetAlternativeOptionalGroup.totalLandedCost = Number.isNaN(_AlternativeOptionalGroupTotalLandedCost) ? 0.0 : _AlternativeOptionalGroupTotalLandedCost.toFixed(3)//.slice(0,-1);							 
                            alterElement.labCalculationSheetAlternativeOptionalGroup.totalMargin = (Number.isNaN((alterElement.labCalculationSheetAlternativeOptionalGroup.groupTotal_WO_VAT-alterElement.labCalculationSheetAlternativeOptionalGroup.totalLandedCost)/alterElement.labCalculationSheetAlternativeOptionalGroup.groupTotal_WO_VAT) || alterElement.labCalculationSheetAlternativeOptionalGroup.groupTotal_WO_VAT==0 ) ? 0.0 
                            : (((alterElement.labCalculationSheetAlternativeOptionalGroup.groupTotal_WO_VAT-alterElement.labCalculationSheetAlternativeOptionalGroup.totalLandedCost)/alterElement.labCalculationSheetAlternativeOptionalGroup.groupTotal_WO_VAT)*100).toFixed(3)//.slice(0,-1);
                            alterElement.labCalculationSheetAlternativeOptionalGroup.totalGrossMarginValue = Number.isNaN(alterElement.labCalculationSheetAlternativeOptionalGroup.groupTotal_WO_VAT-alterElement.labCalculationSheetAlternativeOptionalGroup.totalLandedCost) ? 0.0 : (alterElement.labCalculationSheetAlternativeOptionalGroup.groupTotal_WO_VAT-alterElement.labCalculationSheetAlternativeOptionalGroup.totalLandedCost).toFixed(3)//.slice(0,-1);
                        }
                    });
                    if (element.labCalculationSheetOptionalGroup) {
                        ...
                        element.labCalculationSheetOptionalGroup.labCalculationSheetItem.forEach(
                            (_element) => {
                                if(_element.totalLandedCost != ""){
                                    _OptionalGroupTotalLandedCost += parseFloat(_element.totalLandedCost);
                                }
                                if(_element.total_WO_VAT != ""){
                        ...
                        element.labCalculationSheetOptionalGroup.groupTotal_WO_VAT = Number.isNaN(_OptionalGroupTotal_WO_VAT) ? 0.0 : _OptionalGroupTotal_WO_VAT.toFixed(3)//.slice(0,-1); 
                        element.labCalculationSheetOptionalGroup.groupTotalQuotationPrice = Number.isNaN(_OptionalGroupTotalQuotationPrice) ? 0.0 : _OptionalGroupTotalQuotationPrice.toFixed(3)//.slice(0,-1);							 
                        element.labCalculationSheetOptionalGroup.totalLandedCost = Number.isNaN(_OptionalGroupTotalLandedCost) ? 0.0 : _OptionalGroupTotalLandedCost.toFixed(3)//.slice(0,-1);							 
                        element.labCalculationSheetOptionalGroup.totalMargin = (Number.isNaN((element.labCalculationSheetOptionalGroup.groupTotal_WO_VAT-element.labCalculationSheetOptionalGroup.totalLandedCost)/element.labCalculationSheetOptionalGroup.groupTotal_WO_VAT) || element.labCalculationSheetOptionalGroup.groupTotal_WO_VAT ==0) ? 0.0 : (((element.labCalculationSheetOptionalGroup.groupTotal_WO_VAT-element.labCalculationSheetOptionalGroup.totalLandedCost)/element.labCalculationSheetOptionalGroup.groupTotal_WO_VAT)*100).toFixed(3)//.slice(0,-1)
                        element.labCalculationSheetOptionalGroup.totalGrossMarginValue = Number.isNaN(element.labCalculationSheetOptionalGroup.groupTotal_WO_VAT-element.labCalculationSheetOptionalGroup.totalLandedCost) ? 0.0 : (element.labCalculationSheetOptionalGroup.groupTotal_WO_VAT-element.labCalculationSheetOptionalGroup.totalLandedCost).toFixed(3)//.slice(0,-1);
                    }
                });
            }
        },
        ...
        var urlStr =
            ...
            "api/LabCalculationSheets/"+this.calSheetId+"/Export"
        axios({
            method: "post",
            url: urlStr,
                    ...
                    excellist.forEach(row => {
                        if(row.length){//to skip empty row
                            ...
                            if (row[0]){//to skip total row
                                let labCalculationSheetItem = JSON.parse(JSON.stringify(this.labCalculationSheetItem));
                                if (row[3]) {
                                    ...
                                    if (obj) {
                                        ...
                                        labCalculationSheetItem.onHandPriceCurrencySymbol = obj.currencySymbol
                                ...
                                if (labCalculationSheetItem.code) {
                                    labCalculationSheetItem.tenderUnitM= row[5] ? parseInt(row[5]) : -1
                                    labCalculationSheetItem.tenderUnit= row[5] ? parseInt(row[5]) : ""
                                    labCalculationSheetItem.tenderUnitValue= row[6] ? parseInt(row[6]) : ""
                                    ...
                                    labCalculationSheetItem.currencyCode= row[13] || this.tenderCalculationSheetCode
                                    labCalculationSheetItem.currencySymbol=this.currenciesList.find(x=>x.code==row[13])?this.currenciesList.find(x=>x.code==row[13]).currencySymbol:this.currenciesList.find(x=>x.code==this.tenderCalculationSheetCode).currencySymbol
                                    ...
                                    labCalculationSheetItem.landedCostInSelectedCurrency = row[19] || ""
                                    labCalculationSheetItem.totalLandedCost = row[20] || ""
                                    labCalculationSheetItem.totalLandedCostInSelectedCurrency = row[21] || ""
                                    labCalculationSheetItem.grossMargin = row[22] || ""
                                    labCalculationSheetItem.quotationSupplier_WithOut_Vat = row[23] || ""
                                    labCalculationSheetItem.quotationSupplier_With_Vat = row[24] || ""
                                    ...
                                    if (groupTitle.length==1) {//to add main groups
                                        ...
                                        let tenderCalculationSheetGroup = JSON.parse(JSON.stringify(this.tenderCalculationSheetGroup));
                                        ...
                                        tenderCalculationSheetGroup.labCalculationSheetItem= [labCalculationSheetItem]
                                        if (!groupObj)
                                        this.tenderCalculationSheetGroups.push(tenderCalculationSheetGroup);
                                        else {
                                            groupObj.labCalculationSheetItem.push(labCalculationSheetItem);
                                        }
                                    }
                                        ...
                                        let alternativeGroupObj = groupObj.labCalculationSheetAlternativeGroup.find((x,index)=>index==alternativeGroupIndex)
                                        let labCalculationSheetAlternativeGroup = JSON.parse(JSON.stringify(this.labCalculationSheetAlternativeGroup));
                                        labCalculationSheetAlternativeGroup.labCalculationSheetMainGroupId= groupObj.id ? groupObj.id : "";
                                        labCalculationSheetAlternativeGroup.labCalculationSheetItem= [labCalculationSheetItem];
                                        labCalculationSheetAlternativeGroup.name = row[1] || "";
                                        if (!alternativeGroupObj)
                                        groupObj.labCalculationSheetAlternativeGroup.push(labCalculationSheetAlternativeGroup);
                                        else {
        ...
        getCalculationSheetCurrency: function(query = "") {
            ...
            var urlStr =
                ...
                +"&department="+ this.$store.getters.getDepartmentCode.lab;
            this.$http
                .get(urlStr, {
                    headers: this.$store.getters.tokenAuthonticationHeaderObj
                })
        ...
        getTotalAmountTotalGrossMarginTotalGrossMarginValue() {
            ...
            this.tenderCalculationSheetGroups.forEach(element => {
                if (element.labCalculationSheetItem &&
            ...
            this.bankBlockViewModel.totalGrossMarginValue = (this.bankBlockViewModel.total_Quoted_Price_WO_VAT  - Total_Landed_Cost).toFixed(3);//Number.isNaN(totalGrossMarginValue) ? 0.0 : (totalGrossMarginValue).toFixed(3)//.slice(0,-1);
            this.bankBlockViewModel.totalGrossMargin =  (Number.isNaN((this.bankBlockViewModel.total_Quoted_Price_WO_VAT-Total_Landed_Cost)/this.bankBlockViewModel.total_Quoted_Price_WO_VAT ) || this.bankBlockViewModel.total_Quoted_Price_WO_VAT==0 ) ? 0.0 : (((this.bankBlockViewModel.total_Quoted_Price_WO_VAT-Total_Landed_Cost)/this.bankBlockViewModel.total_Quoted_Price_WO_VAT)*100).toFixed(3)//.slice(0,-1);
        ...
        calculatorMainItemChange(rowItem) {
            ...
            if(MSSUnit != 0.0){
                var ms_qty = ((parseFloat(TenderQty) * parseFloat(tenderUnit)) / parseFloat(MSSUnit))
                rowItem.msS_Quantity = ms_qty
                rowItem.msS_Quantity = Number.isNaN(rowItem.msS_Quantity) ? 0.0 : Math.ceil(rowItem.msS_Quantity);
            }
            let landedCostInSelectedCurrency = parseFloat(cost) * (1 + parseFloat(shipment) / 100);
            rowItem.landedCostInSelectedCurrency = parseFloat(landedCostInSelectedCurrency).toFixed(3)
            rowItem.landedCost = parseFloat(landedCostInSelectedCurrency * currencyConversion).toFixed(3)

            if(rowItem.msS_Quantity != 0.0){
                rowItem.totalLandedCostInSelectedCurrency = parseFloat(landedCostInSelectedCurrency * parseFloat(rowItem.msS_Quantity)).toFixed(3)
                rowItem.totalLandedCost = parseFloat(landedCostInSelectedCurrency * currencyConversion * parseFloat(rowItem.msS_Quantity)).toFixed(3)
            }
            else{
            ...
            if (finalUnitPrice != 0.0) {
                if (this.isVat == true && this.VAT > 0) {
                    rowItem.grossMargin = parseFloat(((parseFloat(finalUnitPrice)/ (1 + parseFloat(this.VAT / 100)) -parseFloat(rowItem.landedCost))/(parseFloat(finalUnitPrice) / (1 + parseFloat(this.VAT / 100))))*100).toFixed(3);
                }
                else{
                    rowItem.grossMargin = parseFloat(((parseFloat(finalUnitPrice)-parseFloat(rowItem.landedCost))/(parseFloat(finalUnitPrice)))*100).toFixed(3);
                }
            } else rowItem.grossMargin = 0.0;
            let quotationSupplier_WithOut_Vat = parseFloat(landedCostInSelectedCurrency * currencyConversion) / (1 - parseFloat(rowItem.grossMargin) / 100)
            rowItem.quotationSupplier_WithOut_Vat = parseFloat(quotationSupplier_WithOut_Vat).toFixed(3)

            if (this.isVat == true && this.VAT > 0) {
                rowItem.quotationSupplier_With_Vat = parseFloat(parseFloat(quotationSupplier_WithOut_Vat) * (1 + parseFloat(this.VAT / 100))).toFixed(3);
            }
            else{
                rowItem.quotationSupplier_With_Vat = parseFloat(quotationSupplier_WithOut_Vat).toFixed(3);
            }
            // rowItem.totalQuotationPrice = parseFloat(rowItem.quotationSupplier_With_Vat * rowItem.msS_Quantity).toFixed(3);

            rowItem.totalQuotationPrice = parseFloat(finalUnitPrice * rowItem.msS_Quantity).toFixed(3);// depending on sujoud it should be in this way 15-11-2023.
            rowItem.totalQuotationPrice_not_rounded = parseFloat(finalUnitPrice * rowItem.msS_Quantity);
            rowItem.total_WO_VAT_not_rounded = finalUnitPrice==0?0.0: (finalUnitPrice * (1 - parseFloat(this.VAT / 100)) * parseFloat(rowItem.msS_Quantity));
            rowItem.total_WO_VAT=(rowItem.total_WO_VAT_not_rounded).toFixed(3);
            rowItem.grossMarginValue = parseFloat((parseFloat(rowItem.quotationSupplier_WithOut_Vat) - parseFloat(rowItem.landedCost)) * parseFloat(rowItem.msS_Quantity)).toFixed(3);
        ...
        FillData: function() {
            ...
            this.$http
                ...
                .then(
                    function(data) {
                        this.mainGroupPrevCount = data.body.labCalculationSheetMainGroup ? data.body.labCalculationSheetMainGroup.length : 0;
                        ...
                        this.bankBlockViewModel.totalGrossMarginValue = data.body.bankBlockViewModel.totalGrossMarginValue;
                        this.bankBlockViewModel.totalGrossMargin = data.body.bankBlockViewModel.totalGrossMargin;
        ...
        addNewMainSheetItem(index) {
            ...
            labCalculationSheetItem.currencySymbol = this.currenciesList.filter(x=>x.code==this.tenderCalculationSheetCode)[0].currencySymbol;
                
            this.tenderCalculationSheetGroups[index].labCalculationSheetItem.push(labCalculationSheetItem);
        ...
        addNewAlternativeGroup(index) {
            ...
            labCalculationSheetItem.currencySymbol = this.currenciesList.filter(x=>x.code==this.tenderCalculationSheetCode)[0].currencySymbol;
            let labCalculationSheetAlternativeGroup = JSON.parse(JSON.stringify(this.labCalculationSheetAlternativeGroup));
            labCalculationSheetAlternativeGroup.labCalculationSheetMainGroupId = this.tenderCalculationSheetGroups[index].id ?
                    this.tenderCalculationSheetGroups[index].id :
                    "";
            labCalculationSheetAlternativeGroup.labCalculationSheetItem = [labCalculationSheetItem],
            this.tenderCalculationSheetGroups[index].labCalculationSheetAlternativeGroup.push(labCalculationSheetAlternativeGroup);
            this.totalAlternativeAmountIndex =
                this.tenderCalculationSheetGroups[index].labCalculationSheetAlternativeGroup
                .length - 1;
        },
        ...
        addNewAlternativeOptionalItem(index, alternativeGroupIndex) {
            ...
            ].labCalculationSheetAlternativeOptionalGroup.labCalculationSheetItem.push(labCalculationSheetItem);
            ...
            this.$msgbox({
                ...
                if (action === "confirm") {
                    this.tenderCalculationSheetGroups[
                        index
                    ].labCalculationSheetAlternativeGroup.splice(alternativeGroupIndex, 1);
                    done();
                } else {
                    done();
                 }
        ...
        removeSingleOptionalGroup(index) {
            ...
            this.$msgbox({
                ...
                beforeClose: (action, instance, done) => {
                if (action === "confirm") {
                    this.tenderCalculationSheetGroups[index].labCalculationSheetOptionalGroup = null;
                    done();
                } else {
                    done();
                 }
        ...
        removeCalcuationSheetMainItems(index, item) {
            ...
            this.$msgbox({
                ...
                beforeClose: (action, instance, done) => {
                if (action === "confirm") {
                    this.tenderCalculationSheetGroups[index].labCalculationSheetItem.splice(
                    this.tenderCalculationSheetGroups[index].labCalculationSheetItem.indexOf(item),
                    1);
        ...
        removeOptionalItem(index, item) {
            ...
            this.$msgbox({
                ...
                this.tenderCalculationSheetGroups[
                    index
                ].labCalculationSheetOptionalGroup.labCalculationSheetItem.indexOf(item),
                1
            );
                    done();
                } else {
                            ...
                            prelistOptionalConfig.map(function(val) {
                                if (val == MainConfigGroup.id) {
                                    MainConfigGroup.itemGroupOptionalItem.map(function(value) {
                                        var item = JSON.parse(JSON.stringify(this.labCalculationSheetItem));
                                        ...
                                        item.onHandPriceCurrencySymbol= value.onHandPriceCurrencySymbol
                                        item.onHandQuantity= value.onHandQuantity
                                        item.cost= value.onHandPrice
                                        item.currencyCode= vm.tenderCalculationSheetCode
                                        item.currencySymbol=vm.currenciesList.filter(x=>x.code==vm.tenderCalculationSheetCode)[0].currencySymbol
                            ...
                            MainConfigGroup.itemGroupMainConfig.map(function(
                                ...
                                if (prelistItemGroup.mainConfigId == mainConfigItems.id) {
                                    mainConfigItems.itemGroupMainConfigItems.map(function(
                                        ...
                                        item.onHandPrice= groupMainConfigItemsObjectOfArray.onHandPrice
                                        item.onHandPriceCurrency= groupMainConfigItemsObjectOfArray.onHandPriceCurrency
                                        item.onHandPriceCurrencySymbol= groupMainConfigItemsObjectOfArray.onHandPriceCurrencySymbol
                                        item.onHandQuantity= groupMainConfigItemsObjectOfArray.onHandQuantity
                            ...
                            MainConfigGroup.itemGroupMainConfig.map(function(
                                ...
                                if (prelistItemGroup.mainConfigId == mainConfigItems.id) {
                                    mainConfigItems.itemGroupMainConfigItems.map(function(
                                        ...
                                        item.cost= groupMainConfigItemsObjectOfArray.onHandPrice
                                        item.currencyCode= vm.tenderCalculationSheetCode
                                        item.currencySymbolvm.currenciesList.filter(x=>x.code==vm.tenderCalculationSheetCode)[0].currencySymbol
                                        mainItemsConfig.push(item);
                                        //vm.getItemCodeName(item)
                                        //vm.getItemCodeNameByName(item)
                                    });
        ...
        AddGroupByMainConfig(mainItemsList, OptionalItemList) {
            ...
            tenderCalculationSheetGroup.labCalculationSheetOptionalGroup= optionalItems
            this.tenderCalculationSheetGroups.push(tenderCalculationSheetGroup);
        },
                 ...
                 if (val && val.length > 0) {
                    val.forEach((element) => {
                        ...
                        element.labCalculationSheetAlternativeGroup.forEach(alterElement => {
                            ...
                            if (alterElement.labCalculationSheetAlternativeOptionalGroup != null) {
                                alterElement.labCalculationSheetAlternativeOptionalGroup.labCalculationSheetItem.forEach(
                                    (_elementOptional) => {
       ...
       deleteSelectedForCalcuationSheetMainItems(index){
        if(!this.tenderCalculationSheetGroups[index].labCalculationSheetItem ||
        this.tenderCalculationSheetGroups[index].labCalculationSheetItem.length ==0)
            return;
        ...
        const h = this.$createElement;
            this.$msgbox({
                ...
                if (action === "confirm") {
                    ...
                    this.$set( this.tenderCalculationSheetGroups[index], "labCalculationSheetItem",  
                    this.tenderCalculationSheetGroups[index].labCalculationSheetItem.filter(  item => !item.selected ) );
       ...
       deleteSelectedForCalcuationSheetAlternativeItem(index,alternativeGroupIndex){
        if(!this.tenderCalculationSheetGroups[index].labCalculationSheetAlternativeGroup[ alternativeGroupIndex ].labCalculationSheetItem ||
        this.tenderCalculationSheetGroups[index].labCalculationSheetAlternativeGroup[ alternativeGroupIndex ].labCalculationSheetItem.length ==0)
            return;
        ...
        const h = this.$createElement;
            this.$msgbox({
                ...
                beforeClose: (action, instance, done) => {
                if (action === "confirm") {
                    this.$set( this.tenderCalculationSheetGroups[index].labCalculationSheetAlternativeGroup[ alternativeGroupIndex ], "labCalculationSheetItem",  
                    this.tenderCalculationSheetGroups[index].labCalculationSheetAlternativeGroup[ alternativeGroupIndex ].labCalculationSheetItem.filter(  item => !item.selected ) );
       ...
       deleteSelectedForCalcuationSheetOptionalGroupItems(index){
        if(! this.tenderCalculationSheetGroups[index].labCalculationSheetOptionalGroup.labCalculationSheetItem ||
        this.tenderCalculationSheetGroups[index].labCalculationSheetOptionalGroup.labCalculationSheetItem.length ==0)
            return;
            ...
            this.$msgbox({
                ...
                beforeClose: (action, instance, done) => {
                if (action === "confirm") {
                    this.$set( this.tenderCalculationSheetGroups[index].labCalculationSheetOptionalGroup, "labCalculationSheetItem",  
                    this.tenderCalculationSheetGroups[index].labCalculationSheetOptionalGroup.labCalculationSheetItem.filter(  item => !item.selected ) );
                    done();
                } else {
                    done();
                 }
       ...
       deleteSelectedForCalcuationSheetAlternativeOptionalItem(index,alternativeGroupIndex){
        ...
        if(! this.tenderCalculationSheetGroups[index].labCalculationSheetAlternativeGroup[alternativeGroupIndex].labCalculationSheetAlternativeOptionalGroup.labCalculationSheetItem ||
        this.tenderCalculationSheetGroups[index].labCalculationSheetAlternativeGroup[alternativeGroupIndex].labCalculationSheetAlternativeOptionalGroup.labCalculationSheetItem.length ==0)
            return;
        ...
        const h = this.$createElement;
            this.$msgbox({
                ...
                beforeClose: (action, instance, done) => {
                if (action === "confirm") {
                    this.$set( this.tenderCalculationSheetGroups[index].labCalculationSheetAlternativeGroup[alternativeGroupIndex].labCalculationSheetAlternativeOptionalGroup, "labCalculationSheetItem",  
                    this.tenderCalculationSheetGroups[index].labCalculationSheetAlternativeGroup[alternativeGroupIndex].labCalculationSheetAlternativeOptionalGroup.labCalculationSheetItem.filter(  item => !item.selected ) );
                    done();
                } else {
                    done();
                 }
       ...
       addNewOptionalGroup(index) {
            ...
            this.tenderCalculationSheetGroups[index].labCalculationSheetOptionalGroup = {
                name: "",
                totalAmount: "",
