<template>
  <div ref="calcuationSheetBasicInfo">
                ...
                <div class="col-md-12">
                  <div class="form-group" :class="{'has-error':errors.has('TenderNameCustomer')}">
                    ...
                    <input
                      ...
                      :maxlength="$store.getters.getMaxLength.length50"
...
<!-- -------------------------------------------- -->
    ...
    <b-card class="card card-accent-primary" no-body>
      ...
      <b-collapse id="collapse2" visible>
        <b-card-body
          v-if="BasicInfoObj.labCalculationSheetCurrencyRate.length > 0 && BasicInfoObj.tenderCurrencyCode != ''"
        >
          <div class="table-wrapper-scroll-y my-custom-scrollbar col-md-12">
            <table class="table table-bordered table-striped table-sm">
              ...
              <tbody>
                <tr
                  v-for="(currency, index) in BasicInfoObj.labCalculationSheetCurrencyRate"
                  v-bind:key="index"
                >
        ...
        <b-card-body>
          <div
            ...
            <div class="form-row">
              ...
              <div class="col-md-10">
                <div class="form-row" v-if="labCalculationSheetAttachment">
                  <table
                  ...
                  >
                    ...
                    <tbody v-if="labCalculationSheetAttachment.length >0">
                      <template v-for="(attachemnt,index) in labCalculationSheetAttachment">
                      <tr
                        :key="index"
    ...
    <div class="text-center mb-5">
      <router-link class="btn csubmit ml-3" :to="{ name: 'labCalculationSheetList'}">
...
export default {
  ...
  data() {
    return {
      ...
      tempDataBodyLabCalculationSheetCurrencyRate: [],
      loggeduser: {},
  ...
  methods: {
    ...
    deleteCurrencyRate(index) {
      ...
      this.$msgbox({
        ...
        beforeClose: (action, instance, done) => {
          if (action === "confirm") {
              this.BasicInfoObj.labCalculationSheetCurrencyRate.splice(index, 1);
              done();
          } else {
            done();
          }
    ...
    addCurrency() {
      ...
      if (this.BasicInfoObj.tenderCurrencyCode != obj.code) {
        var check_exsits = this.BasicInfoObj.labCalculationSheetCurrencyRate.find(
          x => x.currencyCode == obj.code
        );
        if (!check_exsits) {
          if (this.calSheetId) {
            this.BasicInfoObj.labCalculationSheetCurrencyRate.push({
              id: obj.id,
    ...
    remoteMethodCurrency: function(query) {
      ...
      if (query !== "") {
        ...
        var urlStr =
          this.$store.getters.serverURI +
          "api/LabItem/GetAllCurrencies?PageIndex=" +
          1 +
          "&PageSize=" +
    ...
    this.loggedUserType = loggeduser && loggeduser.userType? loggeduser.userType:67;
    var urlStr =
          this.$store.getters.serverURI +
      ...
      this.$http
        ...
        .then(
          () => {
            ...
            this.$router.push({ path: "/labCalculationSheets" });
          },
          function() {
            this.$message({
              showClose: true,
    ...
    fetchData: function() {
      var urlStr =
        this.$store.getters.serverURI +
        "api/LabCalculationSheet/GetAttachment/" +
        this.calSheetId;
      this.$http
        .get(urlStr, {
          headers: this.$store.getters.tokenAuthonticationHeaderObj
        ...
        .then(
          function(data) {
            this.labCalculationSheetAttachment = data.body;
            if (this.labCalculationSheetAttachment.length > 0) {
              this.actionType = "put";
            }
          },
          function() {
    ...
    removAttachment(item) {
      this.labCalculationSheetAttachment.splice(
        this.labCalculationSheetAttachment.indexOf(item),
        1
      );
    },
    ...
    createImage(file, fileName) {
      ...
      reader.onload = e => {
        ...
        vm.labCalculationSheetAttachment.push({
          fileName: fileName,
          creationDate: "",
          updateDate: "",
          LabCalculationSheetId: vm.calSheetId,
    ...
    storeAttachmentFiles() {
      ...
      if (this.actionType == "post") {
        urlStr =
          this.$store.getters.serverURI +
          "api/LabCalculationSheet/InsertAttachment";
        this.$http
          .post(
            urlStr,
            {
              labCalculationSheetAttachment: this.labCalculationSheetAttachment
            },
            {
              headers: this.$store.getters.tokenAuthonticationHeaderObj
            }
        ...
        urlStr =
          this.$store.getters.serverURI +
          "api/LabCalculationSheet/UpdateAttachment?LabCalculationSheetId=" +
          this.calSheetId;
        this.$http
          .put(
            urlStr,
    ...
    FillGuaranteeList: function() {
      var urlStr = this.$store.getters.serverURI +
        "api/lookup/GetByType/" +
        this.$store.getters.getLookupCategory.LabBankGuarantee;
      ...
      this.$http
        ...
        .then(
          function(data) {
            ...
            this.labCalculationSheetAttachment =
              data.body.labCalculationSheetAttachment;
    ...
    saveOrUpdate(gonext) {
      this.$validator.validateAll().then(result => {
        if (result) {
          this.fullscreenLoading = true;
          this.BasicInfoObj.labCalculationSheetAttachment = this.labCalculationSheetAttachment;
          var urlStr;
          if (this.calSheetId) {
            urlStr =
              this.$store.getters.serverURI +
              "api/LabCalculationSheet/UpdateBasicInfo";
            this.$http
              ...
              .then(
                () => {
                  ...
                  // if(this.$refs.calcuationSheetBasicInfo)
            ...
            urlStr =
              this.$store.getters.serverURI + "api/LabCalculationSheet/BasicInfo";
            this.$http
    ...
    checkWorkflow() {
      ...
      var urlStr =
        this.$store.getters.serverURI +
        "api/LabCalculationSheet/WorkflowValidationForCreatingSheet";
      this.$http
        .get(urlStr, {
          headers: this.$store.getters.tokenAuthonticationHeaderObj
        })
    ...
    BasicInfoObj: {
      handler(val) {
        ...
        if(val.tenderCurrencyCode){
           var obj = this.BasicInfoObj.labCalculationSheetCurrencyRate.find(x => x.currencyCode === val.tenderCurrencyCode);
            if(obj){
              let index = this.BasicInfoObj.labCalculationSheetCurrencyRate.findIndex(x=>x.currencyCode == val.tenderCurrencyCode);
              this.BasicInfoObj.labCalculationSheetCurrencyRate.splice(index, 1);
            }
        }
