<template>
  ...
  >
    ...
    <b-collapse id="collapse1" visible>
      <b-card-body>
        <form class="form-horizontal" @submit.prevent="geTLabCalculationSheetList">
          <div class="row">
            <!-- <div class="col-md-4">
          ...
          <div class="row">
            <div class="col-md-12 mt-3 mb-3">
              ...
              <router-link
                ...
                :to="{ name: 'labNewCalculationSheet'}"
        ...
        >
          ...
          <el-table-column label="Last modified date" 
           sortable        
          ...
          <el-table-column label="Actions" :min-width="10">
            <template slot-scope="scope">
              <router-link
                ...
                :to="{ name: 'LabViewCalculationSheet', params: {CalSheetId: scope.row.id}}">
                <i class="fa fa-eye"></i>
              </router-link>
              ...
              <router-link
                ...
                :to="{ name: 'labWorkflowLog', params: {labCalculationSheetId: scope.row.id}}">
                <i class="fa fa-history"></i>
              </router-link>

              <router-link
                :title="$t('Edit')"
                v-if="scope.row.status != 4 && scope.row.status != 7 && scope.row.viewOnly != true && checkActions('Edit')"
                class="text-primary pr-1"
                :to="{ name: 'labNewCalculationSheet', params: {CalSheetId: scope.row.id}}">
                <i class="fa fa-edit"></i>
              </router-link>

              <!-- <a
                :title="$t('addversion')"
                @click="addLabCalculationSheetVersion(scope.row.id)"
                v-if="scope.row.status == 4 && scope.row.status != 7 && scope.row.createdBy == loggeduser && scope.row.viewOnly != true"
                class="text-primary pr-1">
              ...
              <a
                :title="$t('addCopy')"
                @click="addLabCalculationSheetCopy(scope.row.id)"
              ...
              <a
                :title="$t('Delete')"
                class="text-danger"
                v-if="scope.row.status !=4 && scope.row.status != 7 && checkActions('Delete') && scope.row.viewOnly != true"
                v-on:click="deleteLabCalculationSheetItem(scope.row.id);">
      ...
      <!-- <div class="table-responsive">
            <table class="table table-bordered table-sm table-striped dataTable">
              ...
              <tbody>
                <tr v-for="(calcsheet, index) in LabCalculationSheetList" v-bind:key="index">
                  ...
                  <td class="action-column text-center">
                    <router-link
                      ...
                      title="View to ction"
                      class="text-primary"
                      :to="{ name: 'tenderViewLabCalculationSheet', params: {CalSheetId: calcsheet.id}}"
                    >
                      <i class="fa fa-eye"></i>
                    </router-link>
                    ...
                    <router-link
                      :title="$t('WorkflowLog')"
                      class="text-defualt"
                      :to="{ name: 'WorkflowLog', params: {LabCalculationSheetId: calcsheet.id}}"
                    >
                      <i class="fa fa-history"></i>
                    </router-link>
                    ...
                    <router-link
                      ...
                      class="text-primary"
                      :to="{ name: 'labNewCalculationSheet', params: {CalSheetId: calcsheet.id}}"
                    >
                      <i class="fa fa-edit"></i>
                    </router-link>
                    <a
                      :title="$t('addversion')"
                      @click="addLabCalculationSheetVersion(calcsheet.id)"
                    ...
                    <a
                      ...
                      v-on:click="deleteLabCalculationSheetItem(calcsheet.id);"
                    >
                      <i class="fa fa-trash"></i>
                    </a>
                  </td>
...
export default {
  ...
  methods: {
    ...
    sort(sortProps) {
      ...
      this.geTLabCalculationSheetList();
    },
    Excel() {
      var submissionDate = "";
      // var releaseDate = "";
      ...
      var urlStr =
        this.$store.getters.serverURI +
        "api/LabCalculationSheets/ExportToExcel?PageIndex=" +
      ...
      axios({
        ...
        fileLink.setAttribute("download", "LabCalculationSheet.xlsx");
    ...
    geTLabCalculationSheetList() {
      ...
      var urlStr =
        this.$store.getters.serverURI +
        "api/LabCalculationSheet?PageIndex=" +
        this.page.currentPage +
        "&PageSize=" +
        this.page.itemsPerPage +
        "&RowsCount=" +
      ...
      this.$http
        ...
        .then(
          function(data) {
            this.fullscreenLoading = false;
            this.LabCalculationSheetList = data.body.list;
    ...
    FillStatus: function() {
      var urlStr =
        this.$store.getters.serverURI + "api/LabCalculationSheet/GetAllStatus";
      this.$http
        .get(urlStr, {
          headers: this.$store.getters.tokenAuthonticationHeaderObj
        })
    ...
    addLabCalculationSheetCopy: function(CalcuationSheetID) {
      this.fullscreenLoading = true
      var urlStr =
        this.$store.getters.serverURI + "api/LabCalculationSheet/AddCopy/" +
        CalcuationSheetID;
      this.$http
        .post(
          urlStr,
    ...
    addLabCalculationSheetVersion: function(CalcuationSheetID) {
      this.fullscreenLoading = true
      var urlStr =
        this.$store.getters.serverURI +
        "api/LabCalculationSheet/AddVersion/" +
        CalcuationSheetID;
      this.$http
        .post(
          urlStr,
    ...
    deleteLabCalculationSheetItem(LabCalculationSheetId) {
      ...
      this.$msgbox({
        ...
        beforeClose: (action, instance, done) => {
          if (action === "confirm") {
            ...
            var urlStr =
              this.$store.getters.serverURI +
              "api/LabCalculationSheet?LabCalculationSheetId=" +
    ...
    FillQuotationReference: function() {
      var urlStr =
        this.$store.getters.serverURI +
        "api/LabCalculationSheet/GeTLabCalculationSheetsTinyInfo";
      this.$http
        .get(urlStr, {
          headers: this.$store.getters.tokenAuthonticationHeaderObj
        })
