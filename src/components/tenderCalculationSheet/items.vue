                        ...
                        >
                          <template slot-scope="scope">
                            <b-form class="form-inline">
                              <b-form-checkbox
                                v-model="scope.row.winningProbability"
                              ></b-form-checkbox
                            ></b-form>
                          </template>
                        </el-table-column>
                        ...
                        >
                          <template slot-scope="scope">
                            <el-select
                              ...
                              @change="changeCostType(scope.row)"
                              clearable
                              filterable
                              name="costType"
                              class="full-width padding-3"
...
<template slot-scope="scope">
    <el-input   @change="calculatorMainItemChange(scope.row)" v-model="scope.row.grossMarginValue" disabled size="mini" autocomplete="off">
                        ...
                        >
                          <template slot-scope="scope">
                            <el-select
                              :loading="loadingAccount"
                              v-model="scope.row.countryofOriginIds"
                              @change="handleCountryofOriginIds(scope.row)"
                              clearable
                              filterable
                              class="full-width padding-3"
                              size="mini"
                      ...
                      ></el-table></div></b-card-body></b-collapse></b-card></b-col></b-row></b-card-body></b-collapse
    ></b-card>
  </div>
</template>
                        </el-table-column>
  ...
  >
    ...
    ></el-option>
        ...
        <el-table-column prop="foB_MSS_Unit" label="FOB MSS UNIT" width="120">
            <template slot-scope="scope">
  <el-input
    v-model="scope.row.foB_MSS_Unit"
  ...
  <b-row class="align-items-center">
    <b-col lg="12" class="d-flex align-items-center">
      <el-input
        v-model="scope.row.shippingExpenses"
        :disabled="true"
        @change="calculatorMainItemChange(scope.row)"
        size="mini"
        autocomplete="off"
      ...
      ></el-input>
      <el-button
        @click="showShippingExpensesDialog(scope.row)"
        :disabled="scope.row.costTypeCode != 3"
      >
        <i class="fa fa-eye"></i>
      </el-button>
  ...
  >
                        ...
                        <el-table-column prop="cif" label="CIF" width="120">
                        <template slot-scope="scope">
  <el-input
    @input="handleDecimal(scope.row)"
    disabled
    @change="
      reEquation('cif', scope.row);
      calculatorShipmentMarginItemChange(scope.row);
      scope.row.cifPlaceHolder = '';
    "
    v-model="scope.row.cif"
    size="mini"
    autocomplete="off"
  >
  </el-input>
  ...
  <el-input
    ...
    @change="
      ...
      scope.row.cifPlaceHolder = '';
    "
    v-model="scope.row.cifValueInTheSelectedCurrency"
    size="mini"
    autocomplete="off"
    :placeholder="scope.row.cifPlaceHolder"
  >
  </el-input>
</template>
                        </el-table-column> 
  ...
  >
                    ...
                    <el-table-column prop="factor" label="Factor" width="120">
                        <template slot-scope="scope">
  <el-input
    @input="handleDecimal(scope.row)"
    :disabled="scope.row.costTypeCode == 2"
    @change="
      reEquation('factor', scope.row);
      calculatorShipmentMarginItemChange(scope.row);
    "
  ...
  <el-input
    @change="
      reEquation('suggested', scope.row);
      calculatorMainItemChange(scope.row, 'suggestedQuotedPrice_WO_VAT');
      scope.row.suggestedQuotedPrice_WO_VATPlaceHolder = '';
    "
    v-model="scope.row.suggestedQuotedPrice_WO_VAT"
    size="mini"
    autocomplete="off"
  ></el-input>
</template>
  ...
  <el-input
    @change="
      ...
      scope.row.suggestedQuotedPrice_WO_VATPlaceHolder = '';
    "
    v-model="scope.row.suggestedPrice_WO_VAT_SelectedCurrency"
    size="mini"
    autocomplete="off"
    :placeholder="scope.row.suggestedQuotedPrice_WO_VATPlaceHolder"
  ></el-input>
</template>
                    </el-table-column> 
  ...
  <el-input
    ...
    v-model="scope.row.lastWinningPrice_WO_VAT"
    size="mini"
    autocomplete="off"
  >
  </el-input>
  ...
  <el-input
    disabled
    @change="calculatorShipmentMarginItemChange(scope.row)"
    v-model="scope.row.total_WO_VAT"
    size="mini"
    autocomplete="off"
  >
  </el-input>
  ...
  <el-input
    @input="handleDecimal(scope.row)"
    v-model="(scope.row.profitPercentage * 100).toFixed(3)"
    size="mini"
    disabled
    autocomplete="off"
  >
...
<template slot-scope="scope">
    <el-input     v-model="scope.row.adjustedTenderUnitPrice" size="mini" disabled autocomplete="off">
            ...
            <template slot-scope="scope">
  <el-input
    v-model="scope.row.tenderUnitPrice"
    size="mini"
    disabled
    autocomplete="off"
  >
  ...
  >
                    ...
                    <template slot-scope="scope">
  <el-input
    v-model="scope.row.adjustedTenderUnitPrice"
    size="mini"
    disabled
    autocomplete="off"
  >
  ...
  <el-input
    autocomplete="off"
    v-model="scope.row.regularPrice"
    size="mini"
  ></el-input>
</template>
                        </el-table-column>
  ...
  >
                        ...
                        <el-table-column prop="note" label="Note" width="120">
                            <template slot-scope="scope">
  <el-input autocomplete="off" v-model="scope.row.note" size="mini"> </el-input>
</template>
                        </el-table-column>
...
<template slot-scope="scope">
    <el-input   @change="calculatorMainItemChange(scope.row)" v-model="scope.row.grossMarginValue" disabled size="mini" autocomplete="off">
                        ...
                        <el-table-column prop="countryOfOrigin" label="Country of Origin" width="200">
...
export default {
  ...
  created() {
    this.excelLink =
      ...
      "ExcelTemplates/TenderCalculationSheetItemsTemplete.xlsx";
  ...
  methods: {
    ...
    saveShippingExpensesDialog() {
      this.currentRow.sE_EachContainer =
        this.ShippingExpensesDialog.sE_EachContainer;
      this.currentRow.sE_EachPallet = this.ShippingExpensesDialog.sE_EachPallet;
      this.currentRow.sE_CostPerContainer =
        this.ShippingExpensesDialog.sE_CostPerContainer;
      this.currentRow.shippingExpenses = parseFloat(
        this.currentRow.sE_CostPerContainer /
          (this.currentRow.sE_EachContainer * this.currentRow.sE_EachPallet)
      ).toFixed(3);
          ...
          if (this.isDuplicateMainGroup) {
            ...
            var mainItemsList = JSON.parse(
              ...
              optionalItems = JSON.parse(
                JSON.stringify(
                  this.tenderCalculationSheetGroups[this.groupIndexToDuplicate]
                    .tenderCalculationSheetOptionalGroup
                )
              );
            this.tenderCalculationSheetGroups[
              this.groupIndexToDuplicate
            ].tenderCalculationSheetAlternativeGroup.push({
              name: "",
              selected: false,
              totalAmount: "",
              totalCost: "",
              ...
              groupTotal_WO_VAT: "",
              tenderCalculationSheetMainGroupId: this
                .tenderCalculationSheetGroups[this.groupIndexToDuplicate].id
                ? this.tenderCalculationSheetGroups[this.groupIndexToDuplicate]
                    .id
                : "",
            ...
            this.totalAlternativeAmountIndex =
              this.tenderCalculationSheetGroups[this.groupIndexToDuplicate]
                .tenderCalculationSheetAlternativeGroup.length - 1;
          }
    ...
    calculateTotal() {
      ...
      if (val && val.length > 0) {
        val.forEach((element) => {
          ...
          element.groupTotal_WO_VAT = Number.isNaN(_groupTotal_WO_VAT)
            ? 0.0
            : _groupTotal_WO_VAT.toFixed(3); //.slice(0,-1);
          ...
          element.totalProfit = Number.isNaN(
            element.totalAmount / element.groupTotal_WO_VAT
          )
            ? 0.0
            : ((element.totalAmount / element.groupTotal_WO_VAT) * 100).toFixed(
                3
              ); //.slice(0,-1);

          element.tenderCalculationSheetAlternativeGroup.forEach(
            (alterElement) => {
              ...
              alterElement.groupTotal_WO_VAT = Number.isNaN(
                _AlternativeGroupTotal_WO_VAT
              )
                ? 0.0
                : _AlternativeGroupTotal_WO_VAT.toFixed(3); //.slice(0,-1);
              ...
              alterElement.totalProfit = Number.isNaN(
                alterElement.totalAmount / alterElement.groupTotal_WO_VAT
              )
                ? 0.0
                : (
                    (alterElement.totalAmount /
                      alterElement.groupTotal_WO_VAT) *
                    100
                  ).toFixed(3); //.slice(0,-1);

              if (
                alterElement.tenderCalculationSheetAlternativeOptionalGroup !=
                null
              ) {
                ...
                alterElement.tenderCalculationSheetAlternativeOptionalGroup.groupTotal_WO_VAT =
                  Number.isNaN(_AlternativeOptionalGroupTotal_WO_VAT)
                    ? 0.0
                    : _AlternativeOptionalGroupTotal_WO_VAT.toFixed(3); //.slice(0,-1);
                alterElement.tenderCalculationSheetAlternativeOptionalGroup.groupTotalQuotationPrice =
                ...
                alterElement.tenderCalculationSheetAlternativeOptionalGroup.totalAmount =
                ...
                alterElement.tenderCalculationSheetAlternativeOptionalGroup.totalProfit =
                  Number.isNaN(
                    alterElement.tenderCalculationSheetAlternativeOptionalGroup
                      .totalAmount /
                      alterElement
          ...
          if (element.tenderCalculationSheetOptionalGroup) {
            ...
            element.tenderCalculationSheetOptionalGroup.groupTotal_WO_VAT =
              Number.isNaN(_OptionalGroupTotal_WO_VAT)
                ? 0.0
                : _OptionalGroupTotal_WO_VAT.toFixed(3); //.slice(0,-1);
            element.tenderCalculationSheetOptionalGroup.totalAmount =
              Number.isNaN(OptionalAmount) ? 0.0 : OptionalAmount.toFixed(3); //.slice(0,-1);
            // var OptionalTotalProfit =  Number.isNaN( _OptionalGroupTotalProfit ) ? 0.0 : OptionalMargin.toFixed(3)//.slice(0,-1);
            element.tenderCalculationSheetOptionalGroup.groupTotalQuotationPrice =
            ...
            element.tenderCalculationSheetOptionalGroup.totalProfit =
              Number.isNaN(
                ...
                : (
                    (element.tenderCalculationSheetOptionalGroup.totalAmount /
                      element.tenderCalculationSheetOptionalGroup
                        .groupTotal_WO_VAT) *
                    100
                  ).toFixed(3); //.slice(0,-1)
          }
    ...
    SuggestionLabel() {
      return (
        this.$t("SuggestedQuotedPriceWOVAT") +
        " - " +
    ...
    changeCostType(row) {
      ...
      if (item.length > 0) row.costTypeCode = item[0].code;
          ...
          if (row.length) {
            ...
            if (row[0]) {
              ...
              let tenderCalculationSheetItem = {
                quantity: "",
                cost: row[6],
                costType: this.costTypeList.find((x) => x.name == row[9])
                  ? this.costTypeList.find((x) => x.name == row[9]).id
                  : 14,
                discount1: "",
                discount2: "",
                ...
                currencySymbol: this.currenciesList.find(
                  ...
                  ? this.currenciesList.find((x) => x.code == row[20])
                      .currencySymbol
                ...
                costTypeCode: this.costTypeList.find((x) => x.name == row[9])
                  ? this.costTypeList.find((x) => x.name == row[9]).code
                  : 1,
              ...
              if (row[3]) {
                ...
                if (obj) {
                  ...
                  if (!tenderCalculationSheetItem.cost)
                    tenderCalculationSheetItem.cost = obj.onHandPrice;
                  tenderCalculationSheetItem.onHandPriceCurrency = obj.currency;
                  tenderCalculationSheetItem.onHandPriceCurrencySymbol =
                    obj.currencySymbol;
                  tenderCalculationSheetItem.onHandQuantity =
                    obj.onHandQuantity;
              ...
              if (tenderCalculationSheetItem.code) {
                ...
                if (groupTitle.length == 1) {
                  ...
                  if (!groupObj)
                    ...
                    groupObj.tenderCalculationSheetItem.push(
                      tenderCalculationSheetItem
                    );
                  }
                } else {
                  ...
                  let alternativeGroupObj =
                    groupObj.tenderCalculationSheetAlternativeGroup.find(
                  ...
                  if (!alternativeGroupObj)
                    groupObj.tenderCalculationSheetAlternativeGroup.push({
                      ...
                      groupTotalQuotationPrice: "",
                      groupTotal_WO_VAT: "",
                      tenderCalculationSheetMainGroupId: groupObj.id
                        ? groupObj.id
                        : "",
                      tenderCalculationSheetItem: [tenderCalculationSheetItem],
    ...
    getCalculationSheetCurrency: function (query = "") {
      ...
      var urlStr =
        ...
        this.calSheetId +
        "&department=" +
        this.$store.getters.getDepartmentCode.tender;
      this.$http
        .get(urlStr, {
          headers: this.$store.getters.tokenAuthonticationHeaderObj,
        })
    ...
    getItemCodeName(item, fromImport) {
      var code = item.code;
      var name = "";
      var customer = this.BasicInfoObj.mssCustomerCode
    ...
    getTotalAmountTotalGrossMarginTotalGrossMarginValue() {
      ...
      this.tenderCalculationSheetGroups.forEach((element) => {
        if (
          element.tenderCalculationSheetItem &&
      ...
      this.bankBlockViewModel.total_Profit_Amount = Number.isNaN(
        Total_Profit_Amount
      )
        ? 0.0
        : Total_Profit_Amount.toFixed(3); //.slice(0,-1);
      this.bankBlockViewModel.total_Profit_Percentage = Number.isNaN(
        this.bankBlockViewModel.total_Profit_Amount /
    ...
    calculatorMainItemChange(rowItem, columnName) {
      ...
      if (
        rowItem.adjustedTenderUnitPrice &&
        rowItem.adjustedTenderUnitPrice != ""
      ) {
      ...
      if (
        rowItem.suggestedPrice_WO_VAT_SelectedCurrency &&
        rowItem.suggestedPrice_WO_VAT_SelectedCurrency != ""
      ) {
        if (columnName == "suggestedQuotedPrice_WO_VAT") {
          rowItem.suggestedPrice_WO_VAT_SelectedCurrency = parseFloat(
            rowItem.suggestedQuotedPrice_WO_VAT / currencyConversion
          ).toFixed(3);
        }
      ...
      // }
      if (
        rowItem.sE_CostPerContainer &&
        rowItem.sE_CostPerContainer != "" &&
        rowItem.sE_EachContainer &&
        rowItem.sE_EachContainer != "" &&
        rowItem.sE_EachPallet &&
        rowItem.sE_EachPallet != ""
      ) {
        rowItem.shippingExpenses = parseFloat(
          rowItem.sE_CostPerContainer /
            (rowItem.sE_EachContainer * rowItem.sE_EachPallet)
        ).toFixed(3); // seif MSS-108
      }

      if (rowItem.shippingExpenses && rowItem.shippingExpenses != "") {
        //seif108
      ...
      if (
        rowItem.cifValueInTheSelectedCurrency &&
        rowItem.cifValueInTheSelectedCurrency != ""
      ) {
      ...
      rowItem.factor_not_rounded = Factor;
      rowItem.shippingExpenses_not_rounded = ShippingExpenses;
      rowItem.suggestedQuotedPrice_WO_VAT_not_rounded =
        SuggestedQuotedPrice_WO_VAT;
      ...
      if (rowItem.shippingExpenseType == true) {
        ...
        ShippingExpenses = Number.isNaN(ShippingExpenses)
          ? 0.0
          : ShippingExpenses;
      } else {
        //percentage
        ShippingExpenses =
          parseFloat(fOBMSSUnit) * (parseFloat(rowItem.shippingExpenses) / 100);
        ShippingExpenses = Number.isNaN(ShippingExpenses)
          ? 0.0
          : ShippingExpenses;
      ...
      if (rowItem.costTypeCode == 3) {
        if (fOCValue != 0.0) {
          calculatedCIF =
            parseFloat(fOBMSSUnit) / parseFloat(fOCValue) +
          ...
          SuggestedQuotedPrice_WO_VAT_EXCHANGE =
            parseFloat(SuggestedQuotedPrice_WO_VAT) * currencyConversion;
          SuggestedQuotedPrice_WO_VAT_EXCHANGE = parseFloat(
            SuggestedQuotedPrice_WO_VAT_EXCHANGE
          );
          rowItem.suggestedQuotedPrice_WO_VAT = parseFloat(
            SuggestedQuotedPrice_WO_VAT_EXCHANGE
          ).toFixed(3);
          rowItem.suggestedQuotedPrice_WO_VAT_not_rounded = parseFloat(
            SuggestedQuotedPrice_WO_VAT_EXCHANGE
          );

          if (Factor != 0.0) {
            SuggestedQuotedPrice_WO_VAT_EXCHANGE =
              parseFloat(CIF_EXCHANGE) / parseFloat(Factor); ///.toFixed(2).slice(0,-1)
            SuggestedQuotedPrice_WO_VAT_EXCHANGE = Number.isNaN(
              SuggestedQuotedPrice_WO_VAT_EXCHANGE
            )
              ? 0.0
              : SuggestedQuotedPrice_WO_VAT_EXCHANGE;
            SuggestedQuotedPrice_WO_VAT = parseFloat(CIF) / parseFloat(Factor); ///.toFixed(2).slice(0,-1)
            SuggestedQuotedPrice_WO_VAT = Number.isNaN(
              SuggestedQuotedPrice_WO_VAT
            )
              ? 0.0
              : SuggestedQuotedPrice_WO_VAT;
            ...
            SuggestedQuotedPrice_WO_VAT_EXCHANGE =
              rowItem.suggestedQuotedPrice_WO_VAT;
            ...
            Factor =
              parseFloat(CIF_EXCHANGE) /
              parseFloat(rowItem.suggestedQuotedPrice_WO_VAT_not_rounded); //.toFixed(3).slice(0,-1)
      ...
      if (rowItem.costTypeCode == 1) {
        ...
        if (
          Factor != 0.0 &&
          CIF_EXCHANGE != 0.0 &&
          SuggestedQuotedPrice_WO_VAT == 0.0
        ) {
          SuggestedQuotedPrice_WO_VAT = parseFloat(CIF) / parseFloat(Factor); //.toFixed(2).slice(0,-1)
          SuggestedQuotedPrice_WO_VAT_EXCHANGE =
            parseFloat(CIF_EXCHANGE) / parseFloat(Factor);
          rowItem.suggestedPrice_WO_VAT_SelectedCurrency = parseFloat(
            SuggestedQuotedPrice_WO_VAT
          ).toFixed(3);
          rowItem.suggestedQuotedPrice_WO_VAT = parseFloat(
          ...
          rowItem.itemToCalculate =
            this.$store.getters.getCalculatedItem.suggestedQuotedPrice;
        } else if (
          SuggestedQuotedPrice_WO_VAT != 0.0 &&
          CIF_EXCHANGE != 0.0 &&
          Factor == 0.0
          ...
          rowItem.factor_not_rounded = Factor;
          rowItem.itemToCalculate =
            this.$store.getters.getCalculatedItem.factor;
        } else if (
          Factor != 0.0 &&
          SuggestedQuotedPrice_WO_VAT != 0.0 &&
          CIF_EXCHANGE == 0.0
          ...
          CIF_EXCHANGE =
            parseFloat(Factor) *
            parseFloat(SuggestedQuotedPrice_WO_VAT_EXCHANGE);
          CIF_EXCHANGE = parseFloat(CIF_EXCHANGE); //.toFixed(4).slice(0,-1);
          rowItem.cifValueInTheSelectedCurrency = parseFloat(CIF).toFixed(3);
          rowItem.cif = parseFloat(CIF_EXCHANGE).toFixed(3);
      ...
      if (rowItem.msS_Quantity != 0.0) {
        rowItem.total_WO_VAT = (
          parseFloat(SUGGESTION_EXCHANGE) * parseFloat(rowItem.msS_Quantity)
        ).toFixed(3); //.slice(0,-1)
      ...
      if (rowItem.suggestedQuotedPrice_WO_VAT != 0.0) {
        rowItem.profitPercentage_not_rounded =
          (parseFloat(rowItem.suggestedQuotedPrice_WO_VAT) -
            parseFloat(rowItem.ciF_not_rounded)) /
          parseFloat(rowItem.suggestedQuotedPrice_WO_VAT);
        rowItem.profitPercentage =
          rowItem.profitPercentage_not_rounded.toFixed(3);
        rowItem.profitAmount_not_rounded =
          rowItem.profitPercentage *
          parseFloat(rowItem.suggestedQuotedPrice_WO_VAT) *
      ...
      if (MSSUnit != 0.0) {
        if (this.isVat == true && this.VAT > 0) {
          rowItem.tenderUnitPrice = (
            (parseFloat(SUGGESTION_EXCHANGE) / parseFloat(MSSUnit)) *
            parseFloat(tenderUnit) *
            (1 + parseFloat(this.VAT / 100))
          ) /*.toFixed(3).slice(0,-1)*/
            .toFixed(3); //.slice(0,-1);
          rowItem.tenderUnitPrice_not_rounded =
            (parseFloat(SUGGESTION_EXCHANGE) / parseFloat(MSSUnit)) *
            parseFloat(tenderUnit) *
            (1 + parseFloat(this.VAT / 100)) /*.toFixed(3).slice(0,-1)*/; //.toFixed(3).slice(0,-1);
        } else {
          rowItem.tenderUnitPrice = (
            (parseFloat(SUGGESTION_EXCHANGE) / parseFloat(MSSUnit)) *
            parseFloat(tenderUnit)
          ...
          rowItem.tenderUnitPrice_not_rounded =
            (parseFloat(SUGGESTION_EXCHANGE) / parseFloat(MSSUnit)) *
            parseFloat(tenderUnit); //.toFixed(3).slice(0,-1);
        }
      } else {
      ...
      rowItem.adjustedTenderUnitPrice = parseFloat(
        rowItem.tenderUnitPrice_not_rounded
      ).toFixed(3);
      rowItem.adjustedTenderUnitPrice_not_rounded = parseFloat(
        rowItem.tenderUnitPrice_not_rounded
      ); //.toFixed(2);
      AdjustedTenderUnitPrice = rowItem.adjustedTenderUnitPrice;
      rowItem.totalQuotationPrice_not_rounded =
        parseFloat(AdjustedTenderUnitPrice) * parseFloat(TenderQty).toFixed(3); //.toFixed(3).slice(0,-1);
      rowItem.totalQuotationPrice = parseFloat(
        rowItem.totalQuotationPrice_not_rounded
      ).toFixed(3); //.slice(0,-1);

      if (rowItem.cif != "") {
        rowItem.cif = Number.isNaN(rowItem.ciF_not_rounded)
          ? 0.0
          : parseFloat(rowItem.ciF_not_rounded).toFixed(3); //.slice(0,-1);
        rowItem.ciF_not_rounded = Number.isNaN(rowItem.ciF_not_rounded)
          ? 0.0
          : parseFloat(rowItem.ciF_not_rounded); //.toFixed(4).slice(0,-1);
      }
    ...
    reEquation(key, row) {
      if (row.costTypeCode == 1) {
        ...
        if (
          ...
          row.cif = "";
          row.cifValueInTheSelectedCurrency = "";
          row.suggestedQuotedPrice_WO_VATPlaceHolder =
            row.suggestedPrice_WO_VAT_SelectedCurrency;
          row.suggestedQuotedPrice_WO_VAT = "";
          row.suggestedPrice_WO_VAT_SelectedCurrency = "";
        }
    ...
    FillData: function () {
      ...
      this.$http
        ...
        .then(
          function (data) {
            this.mainGroupPrevCount = data.body.tenderCalculationSheetMainGroup
              ? data.body.tenderCalculationSheetMainGroup.length
              : 0;
            ...
            this.bankBlockViewModel.total_Profit_Amount =
              data.body.bankBlockViewModel.total_Profit_Amount;
            this.bankBlockViewModel.total_Profit_Percentage =
              data.body.bankBlockViewModel.total_Profit_Percentage;
            this.bankBlockViewModel.total_Quoted_Price_WO_VAT =
            ...
            if (data.body.tenderCalculationSheetMainGroup.length) {
              this.tenderCalculationSheetGroups =
                data.body.tenderCalculationSheetMainGroup;
              this.tenderCalculationSheetGroups.forEach((element) => {
                this.groupsCount.push(
                  element.tenderCalculationSheetItem.length
                );
              });
              this.tenderCalculationSheetGroups.forEach((_element) => {
                if (_element.tenderCalculationSheetItem.length > 0) {
                  _element.tenderCalculationSheetItem.forEach((element) => {
                    element.selectedCountryofOriginIds =
                      element.countryofOriginIds;
                  });
                }
                if (
                  _element.tenderCalculationSheetAlternativeGroup.length > 0
                ) {
                  _element.tenderCalculationSheetAlternativeGroup.forEach(
                    (element) => {
                      element.selectedCountryofOriginIds =
                        element.countryofOriginIds;
                    }
    ...
    addNewOptionalGroup(index) {
      ...
      this.totalOptionalAmountIndex =
        this.tenderCalculationSheetGroups[index]
          .tenderCalculationSheetOptionalGroup.length - 1;
    },
      ...
      this.$msgbox({
        ...
        beforeClose: (action, instance, done) => {
          if (action === "confirm") {
            this.tenderCalculationSheetGroups[
              index
            ].tenderCalculationSheetAlternativeGroup.splice(
              alternativeGroupIndex,
              1
            );
            done();
        ...
        beforeClose: (action, instance, done) => {
          if (action === "confirm") {
            this.tenderCalculationSheetGroups[
              ...
              this.tenderCalculationSheetGroups[
                index
              ].tenderCalculationSheetOptionalGroup.tenderCalculationSheetItem.indexOf(
                item
              ),
              1
            );
    ...
    extractMainConfigGroupItem() {
      ...
      var tenderCalculationSheetGroups =
        this.tenderCalculationSheetGroups[this.currentGroupIndex];
    ...
    deleteSelectedForCalcuationSheetAlternativeItem(
      ...
      if (
        !this.tenderCalculationSheetGroups[index]
          .tenderCalculationSheetAlternativeGroup[alternativeGroupIndex]
          .tenderCalculationSheetItem ||
        this.tenderCalculationSheetGroups[index]
          .tenderCalculationSheetAlternativeGroup[alternativeGroupIndex]
          .tenderCalculationSheetItem.length == 0
          ...
          if (action === "confirm") {
            this.$set(
              ...
              this.tenderCalculationSheetGroups[
                ...
                alternativeGroupIndex
              ].tenderCalculationSheetItem.filter((item) => !item.selected)
            );
    ...
    deleteSelectedForCalcuationSheetMainItems(index) {
      if (
        !this.tenderCalculationSheetGroups[index].tenderCalculationSheetItem ||
        this.tenderCalculationSheetGroups[index].tenderCalculationSheetItem
          .length == 0
      )
        return;
    ...
    deleteSelectedForCalcuationSheetOptionalGroupItems(index) {
      if (
        !this.tenderCalculationSheetGroups[index]
          .tenderCalculationSheetOptionalGroup.tenderCalculationSheetItem ||
        this.tenderCalculationSheetGroups[index]
          .tenderCalculationSheetOptionalGroup.tenderCalculationSheetItem
          .length == 0
      )
        ...
        beforeClose: (action, instance, done) => {
          if (action === "confirm") {
            this.$set(
              ...
              this.tenderCalculationSheetGroups[
                index
              ].tenderCalculationSheetOptionalGroup.tenderCalculationSheetItem.filter(
                (item) => !item.selected
              )
            );
            done();
          ...
          if (action === "confirm") {
            this.$set(
              ...
              this.tenderCalculationSheetGroups[
                ...
                alternativeGroupIndex
              ].tenderCalculationSheetAlternativeOptionalGroup.tenderCalculationSheetItem.filter(
                (item) => !item.selected
              )
            );
            done();
