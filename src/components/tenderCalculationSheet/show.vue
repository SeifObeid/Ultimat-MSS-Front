<template>
  <div>
    <div class="text-right mb-2">
      ...
      <button
        v-if="BasicInfoObj.status == 4 && BasicInfoObj.isFinalVersion != false"
                  ...
                  <b-card-body>
                    <div class="table-responsive-lg table-responsive">
                      <el-table
                        ...
                        <el-table-column sortable prop="tenderUnitValue" label="Tender Unit Value" width="120">
                           <template slot-scope="scope">
                            {{scope.row.tenderUnitValue | toUSD}}
                          </template>  
                        </el-table-column>
                        <el-table-column sortable prop="msS_Unit" label="MSS Unit" width="120"></el-table-column>
                        <el-table-column sortable prop="mssUnitValue" label="MSS Unit Value" width="120"></el-table-column>
                        ...
                        <!-- <el-table-column sortable prop="unitLandedPriceWithQC" label="Unit landed price w quoted currency" width="260">
                          <template slot-scope="scope"> {{scope.row.unitLandedPriceWithQC | toUSD}}</template>
                        </el-table-column> -->
                        


                        <el-table-column sortable prop="foB_MSS_Unit" label="FOB MSS UNIT" width="140"></el-table-column>
                        <el-table-column sortable prop="shippingExpenses" label="Shipping Expenses" width="160"></el-table-column>
                        <el-table-column sortable prop="shippingExpenseType" label="Value or percentage" width="160">
                          <template slot-scope="scope">
                            <span v-if="scope.row.shippingExpenseType">{{$t('Percentage')}}</span>
                            <span v-else>{{$t('Value')}}</span>
                          </template>  
                        </el-table-column>
                        <el-table-column sortable prop="foc" label="FOC / Discount" width="150"></el-table-column>
                    
                        <el-table-column sortable prop="foC_Value" label="FOC / Discount Value" width="200"></el-table-column>
                        <el-table-column sortable prop="cif" label="CIF" width="120"></el-table-column>
                        <el-table-column sortable prop="factor" label="Factor" width="120"></el-table-column>
                        <el-table-column sortable prop="suggestedQuotedPrice_WO_VAT" label="Suggested quoted price W/O VAT (MSS UNIT)" width="320"></el-table-column>
                        <el-table-column sortable prop="lastWinningPrice_WO_VAT" label="Last winning price w/o VAT" width="260"></el-table-column>
                        <el-table-column sortable prop="total_WO_VAT" label="Total Quoted Price W/O VAT" width="220">
                         <template slot-scope="scope">
                            {{scope.row.total_WO_VAT | toUSD}}
                          </template>
                        </el-table-column>
                        <el-table-column sortable prop="profitPercentage" label="Profit %" width="120">
                          <template slot-scope="scope">
                            {{ (scope.row.profitPercentage * 100).toFixed(3) }}
                          </template>
                        </el-table-column>
                        <el-table-column sortable prop="profitAmount" label="Profit #" width="120">
                          <template slot-scope="scope">
                            {{scope.row.profitAmount | toUSD}}
                          </template>
                        </el-table-column>
                        <el-table-column sortable prop="tenderUnitPrice" label="Tender Unit Price" width="160">
                          <template slot-scope="scope">
                            {{scope.row.tenderUnitPrice | toUSD}}
                          </template>
                        </el-table-column>
                        <el-table-column sortable prop="adjustedTenderUnitPrice" label="Adjusted" width="120">
                          <template slot-scope="scope">
                            {{scope.row.adjustedTenderUnitPrice | toUSD}}
                          </template>
                        </el-table-column>
                        <el-table-column sortable prop="totalQuotationPrice" label="Total Quotation Price With VAT" width="220">
                           <template slot-scope="scope">
                            {{scope.row.totalQuotationPrice | toUSD}}
                          </template>
                        </el-table-column>

                        <el-table-column sortable prop="regularPrice" label="Regular price" width="120"></el-table-column>
                    ...
                    >
                      ...
                      <b-collapse :id="'ItemoptionalGroup-'+index" visible>
                        ...
                        <el-table-column sortable prop="profitPercentage" label="Profit %" width="120"></el-table-column>
                        <el-table-column sortable prop="profitAmount" label="Profit #" width="120">
                          <template slot-scope="scope">
                            {{scope.row.profitAmount | toUSD}}
                          </template>
