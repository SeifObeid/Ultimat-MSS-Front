<template>
  ...
  >
    ...
    <b-collapse id="collapse1" visible>
      <b-card-body>
        <form class="form-horizontal" @submit.prevent="geTtenderCalculationSheetList">
          <div class="row">
            <!-- <div class="col-md-4">
          ...
          <div class="row">
            <div class="col-md-12 mt-3 mb-3">
              ...
              <router-link
                ...
                :to="{ name: 'tenderNewCalculationSheet'}"
        ...
        <el-table
          ref="myTable"
          :data="tenderCalculationSheetList"
          border
          style="width: 100%"
          @sort-change="sort"
        >
          ...
          <el-table-column label="Actions" :min-width="10">
            <template slot-scope="scope">
              <router-link
                ...
                :to="{ name: 'tenderViewCalculationSheet', params: {CalSheetId: scope.row.id}}">
                <i class="fa fa-eye"></i>
              </router-link>
              ...
              <router-link
                ...
                :to="{ name: 'tenderWorkflowLog', params: {tenderCalculationSheetId: scope.row.id}}">
              ...
              <router-link
                ...
                class="text-primary pr-1"
                :to="{ name: 'tenderNewCalculationSheet', params: {CalSheetId: scope.row.id}}">
                <i class="fa fa-edit"></i>
              </router-link>

              <!-- <a
                :title="$t('addversion')"
                @click="addTenderCalculationSheetVersion(scope.row.id)"
              ...
              <a
                :title="$t('addCopy')"
                @click="addTenderCalculationSheetCopy(scope.row.id)"
              ...
              <a
                ...
                v-on:click="deleteTenderCalculationSheetItem(scope.row.id);">
...
export default {
  ...
  methods: {
    ...
    Excel() {
      ...
      var urlStr =
        this.$store.getters.serverURI +
        "api/TenderCalculationSheets/ExportToExcel?PageIndex=" +
      ...
      axios({
        ...
        fileLink.setAttribute("download", "tenderCalculationSheet.xlsx");
    ...
    addTenderCalculationSheetCopy: function(CalcuationSheetID) {
      this.fullscreenLoading = true
      var urlStr =
        this.$store.getters.serverURI + "api/TenderCalculationSheet/AddCopy/" +
        CalcuationSheetID;
      this.$http
        .post(
          urlStr,
    ...
    deleteTenderCalculationSheetItem(tenderCalculationSheetId) {
      ...
      this.$msgbox({
        ...
        beforeClose: (action, instance, done) => {
          if (action === "confirm") {
            ...
            var urlStr =
              this.$store.getters.serverURI +
              "api/TenderCalculationSheet?tenderCalculationSheetId=" +
    ...
    FillQuotationReference: function() {
      var urlStr =
        this.$store.getters.serverURI +
        "api/TenderCalculationSheet/GeTtenderCalculationSheetsTinyInfo";
      this.$http
        .get(urlStr, {
          headers: this.$store.getters.tokenAuthonticationHeaderObj
        })
